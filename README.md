...
Visual C++ 的多个功能区域在此存储库中具有自己的文件夹，例如关于 C++ 标准库主题的 `standard-library`、关于特定于 C++ 的 Visual Studio 交互式开发环境 (IDE) 主题的 `ide` 等等。 每个文件夹中的 `/media` 子文件夹包含主题的剪贴画文件。 [贡献](CONTRIBUTING.md)指南中有更多详细信息。
