...
- 在 [MinGW](http://MinGW.org/) 或 [MinGW-w64](https://sourceforge.net/p/mingw-w64/wiki2/Home/) 环境（这些环境提供从 Linux 到 Windows 系统调用的转换层）中使用 gcc 或 clang 编译程序。
