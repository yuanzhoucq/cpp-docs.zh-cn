...
默认情况下，所有预编译代码都是在文件 pch.h  和 pch.cpp  （Visual Studio 2017 及更低版本中的 stdafx.h  和 stdafx.cpp  ）中指定。 “新建项目”  向导将自动创建这些文件，除非取消选择“预编译标头”  选项。 有关预编译标头的详细信息，请参阅[创建预编译标头文件](../build/creating-precompiled-header-files.md)。
