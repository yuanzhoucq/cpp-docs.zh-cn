---
title: 编译器警告 （等级了 C4121 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46098987"
---
# <a name="compiler-warning-level-4-c4121"></a>编译器警告 （等级了 C4121
...
可以使用[#pragma pack](../../preprocessor/pack.md)或[/Zp](../../build/reference/zp-struct-member-alignment.md)指定结构的对齐方式。 (编译器不会生成此警告 **/Zp1**指定。)