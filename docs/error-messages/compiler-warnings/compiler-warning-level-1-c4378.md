---
title: "编译器警告（等级 1）C4378 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
必须获得函数指针才能运行初始值设定程序；请考虑使用 System::ModuleHandle::ResolveMethodHandle  
  
 在 **\/clr** 下，初始值设定项符号包含函数标记，而不是函数指针。需要使用 <xref:System.ModuleHandle.ResolveMethodHandle%2A> 将标记转换为指针。  
