...
|[编译器错误 C2812](compiler-error-c2812.md)|#导入不支持使用 /clr: pure 和 /clr: safe|  
|[编译器错误 C2813](compiler-error-c2813.md)|#导入不支持 /mp|  
...
|[编译器错误 C2856](compiler-error-c2856.md)|#杂注 hdrstop #if 块内不能为|  
...
|[编译器错误 C2894](compiler-error-c2894.md)|模板不能声明为有“C”链接|  
