...
|[编译器错误 C2702](compiler-error-c2702.md)| __except 可能不在终止块中出现|  
...
|[编译器错误 C2706](compiler-error-c2706.md)|没有匹配 __try 的非法 __except(__try 块中是否缺少“}”?)|  
...
|[编译器错误 C2712](compiler-error-c2712.md)|无法在要求对象展开的函数中使用 __try|  
|[编译器错误 C2713](compiler-error-c2713.md)|每个函数只允许一种异常处理方式|  
|[编译器错误 C2714](compiler-error-c2714.md)|不允许使用 alignof(void)|  
...
|[编译器错误 C2765](compiler-error-c2765.md)|*函数*︰ 函数模板的显式专用化不能有任何默认自变量|  
...
|[编译器错误 C2771](compiler-error-c2771.md)|#导入只能在全局或命名空间范围|  
|编译器错误 C2772|已过时。|  
|[编译器错误 C2773](compiler-error-c2773.md)|#导入和 #using 仅在 c + + 编译器中可用|  
...
|[编译器错误 C2790](compiler-error-c2790.md)|“super”: 该关键字只能在类成员函数体的内部使用|  
|[编译器错误 C2791](compiler-error-c2791.md)|非法使用超级:*类*没有任何基类，这些类|  
|[编译器错误 C2792](compiler-error-c2792.md)|“super”: 该关键字的后面必须跟“::”|  
