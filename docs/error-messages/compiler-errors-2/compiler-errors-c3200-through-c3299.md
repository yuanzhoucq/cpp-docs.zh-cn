...
|[编译器错误 C3222](compiler-error-c3222.md)|*函数*： 托管/WinRT 类型的函数或泛型函数不能声明为成员的默认自变量|
...
|编译器错误 C3249|非法的语句或子表达式 constexpr 函数|
...
|[编译器错误 C3291](compiler-error-c3291.md)|default： 不能作为 trivial 属性名称|
