...
使用的[__declspec](../../cpp/declspec.md)修饰符隐含每个进程状态。  [/clr： pure](../../build/reference/clr-common-language-runtime-compilation.md)表示每个[appdomain](../../cpp/appdomain.md)状态。  因此，不允许使用 `keyword` **__declspec**修饰符声明变量并使用 **/clr： pure**进行编译。
