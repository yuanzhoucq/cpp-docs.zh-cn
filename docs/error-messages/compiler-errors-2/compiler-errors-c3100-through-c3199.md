...
|编译器错误 C3111|初始值设定项列表无法作为模板参数的默认参数使用|  
...
|[编译器错误 C3131](compiler-error-c3131.md)|项目必须有具有“name”属性的“module”特性|  
...
|[编译器错误 C3167](compiler-error-c3167.md)|无法初始化 .NET Framework: 确保它已经安装|  
|[编译器错误 C3168](compiler-error-c3168.md)|*类型*︰ 非法枚举的基础类型|  
|编译器错误 C3169|*类型*︰ 无法从推导为 auto 的类型*类型*|  
|[编译器错误 C3170](compiler-error-c3170.md)|在一个项目中不能有不同的模块标识符|  
...
|[编译器错误 C3198](compiler-error-c3198.md)|使用浮点 pragma 无效: fenv_access pragma 只在精确模式下运行|  
