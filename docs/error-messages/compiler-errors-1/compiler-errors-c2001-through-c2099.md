...
|[编译器错误 C2005](compiler-error-c2005.md)|#行预期行号，却找到*令牌*|  
|[编译器错误 C2006](compiler-error-c2006.md)|*指令*︰ 应为文件名，找到*令牌*|  
|[编译器错误 C2007](compiler-error-c2007.md)|#定义语法|  
...
|[编译器错误 C2055](compiler-error-c2055.md)|应输入形参表，而不是类型表|  
...
|[编译器错误 C2060](compiler-error-c2060.md)|语法错误: 遇到文件结束|  
...
|[编译器错误 C2066](compiler-error-c2066.md)|转换到函数类型是非法的|  
...
|[编译器错误 C2097](compiler-error-c2097.md)|非法的初始化|  
