...
|[编译器错误 C2414](compiler-error-c2414.md)|非法的操作数的数目|
...
|[编译器错误 C2449](compiler-error-c2449.md)|找到 {在文件范围内 （缺少函数标题？）|
...
|[编译器错误 C2486](compiler-error-c2486.md)|__LOCAL_SIZE 只允许在使用 naked 特性的函数|
