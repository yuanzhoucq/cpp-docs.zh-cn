...
1. 如果你正在 64 位平台上进行编译，请使用 64 位编译器工具集。 有关信息，请参阅[如何：在命令行上启用 64 C++位可视化工具集](../../build/how-to-enable-a-64-bit-visual-cpp-toolset-on-the-command-line.md)。
