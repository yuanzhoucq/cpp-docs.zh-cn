...
如果你尝试创建其类型为的 Visual c + + 数组的实例，也可能出现 C2440 <xref:System.Array>。  有关详细信息，请参阅[数组](../../extensions/arrays-cpp-component-extensions.md)。  下一步的示例生成 C2440:
