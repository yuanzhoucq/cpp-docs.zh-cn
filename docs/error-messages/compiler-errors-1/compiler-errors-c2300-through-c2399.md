...
|[编译器错误 C2309](compiler-error-c2309.md)|catch 处理程序预期用圆括号括起来异常声明|
|[编译器错误 C2310](compiler-error-c2310.md)|catch 处理程序必须指定一个类型|
...
|编译器错误 C2330|受 #pragma start_map_region/stop_map_region 的区域，implementation_key （） 才有效|
...
|[编译器错误 C2353](compiler-error-c2353.md)|不允许异常规范|
|编译器错误 C2354|已过时。|
|[编译器错误 C2355](compiler-error-c2355.md)|this： 只能在非静态成员函数或非静态数据成员初始值设定项内部引用|
|[编译器错误 C2356](compiler-error-c2356.md)|在翻译单元期间，初始化段不得更改。|
