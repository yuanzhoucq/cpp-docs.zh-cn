---
title: "编译器错误 C2327 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
“symbol”: 不是类型名称、静态或枚举数  
  
 嵌套类内的代码尝试访问不是类型名称、静态成员或枚举数的封闭类的成员。  
  
 当使用 **\/clr** 进行编译时，发生 C2327 的常见原因是属性与属性类型同名。  
