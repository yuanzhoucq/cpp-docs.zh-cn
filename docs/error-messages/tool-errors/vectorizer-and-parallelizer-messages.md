---
title: 向量化和并行化程序消息 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
|1005|**No_parallel**杂注指定。|
|1006|该函数包含**openmp**。 解决此问题通过删除任何**openmp**中此函数。|
...
|1403|**/arch:ATOM**指定开关，且循环包含对双精度型值的操作。|
|1404|**/ O1**或 **/Os**指定开关。|
