...
ms.locfileid: "58781492"
---
# <a name="linker-tools-error-lnk1000"></a>链接器工具错误 LNK1000

> 未知的错误;参考文档中的技术支持选项

请注意错误的情况下，然后尝试隔离问题并创建可重现的测试用例。 有关如何调查和报告这些错误的信息，请参阅[如何报告 Visual c + + 工具集或文档的问题](../../overview/how-to-report-a-problem-with-the-visual-cpp-toolset.md)。
