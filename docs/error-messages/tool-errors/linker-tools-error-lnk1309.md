...
如果你尝试生成部分受信任的 CLR 纯应用程序使用 ptrustu [d].lib，也会看到 LNK1309。 有关如何创建部分受信任的应用程序的信息，请参阅[如何： 创建部分受信任的应用程序由删除依赖项在 CRT 库 DLL 上](../../dotnet/create-a-partially-trusted-application.md)。
