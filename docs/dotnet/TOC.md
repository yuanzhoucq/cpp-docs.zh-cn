...
# [使用 for each 循环访问 STL 集合](iterating-over-stl-collection-by-using-for-each.md)
...
# [STL/CLR 容器元素的要求](requirements-for-stl-clr-container-elements.md)
...
# [混合、纯 MSIL 和可验证编译模式的功能比较 (C++/CLI)](mixed-pure-and-verifiable-feature-comparison-cpp-cli.md)
