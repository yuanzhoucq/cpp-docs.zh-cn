---
title: 如何： 将命令添加路由到 Windows 窗体控件 |Microsoft Docs
...
2.  添加对 mfcmifc80.dll，可以通过右键单击项目节点中的执行此操作的引用**解决方案资源管理器**，选择**添加**，**引用**，然后浏览到Microsoft Visual Studio 10.0\VC\atlmfc\lib。  
...
4.  此外，在 UserControl1.Designer.cs 中更改此行：  
...
6.  添加以下方法定义为`UserControl1`（我们将在下一步中创建 MFC 控件的 ID）：  
...
7.  打开你在中创建的 MFC 应用程序[如何： 创建用户控件和宿主 MDI 视图](../dotnet/how-to-create-the-user-control-and-host-mdi-view.md)。  
...
## <a name="see-also"></a>请参阅  
 [MFC 视图的形式承载 Windows 窗体用户控件](../dotnet/hosting-a-windows-forms-user-control-as-an-mfc-view.md)   
