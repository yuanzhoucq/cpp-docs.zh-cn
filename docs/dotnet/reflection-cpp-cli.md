...
> [!NOTE]
> 如果使用生成.exe 只允许用 Visual c + + 编译器生成的.exe 上的反射 **/clr: pure**或 **/clr: safe**编译器选项。 **/Clr: pure**和 **/clr: safe**编译器选项将 Visual Studio 2015 中已弃用且 Visual Studio 2017 中不可用。 请参阅[/clr （公共语言运行时编译）](../build/reference/clr-common-language-runtime-compilation.md)有关详细信息。
...
## <a name="example-inspection-of-assemblies"></a>示例： 检查的程序集
