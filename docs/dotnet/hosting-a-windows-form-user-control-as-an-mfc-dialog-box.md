...
4.  添加`#include <afxwinforms.h>`到末尾的现有 stdafx.h`#include`语句。  
...
6.  替换`CDialog`CHostForWinForm.h 和 CHostForWinForm.cpp 文件中`CWinFormsDialog<WindowsControlLibrary1::UserControl1>`。  
