...
## 备注  
 成员函数中有效调用 [multimap::erase](../dotnet/multimap-erase-stl-clr.md)[multimap::begin](../dotnet/multimap-begin-stl-clr.md)[multimap::end](../dotnet/multimap-end-stl-clr.md)`(` `(),` `())`。  用以确保控制序列为空。  
