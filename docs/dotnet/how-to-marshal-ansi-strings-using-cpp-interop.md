...
ms.locfileid: "64345753"
---
# <a name="how-to-marshal-ansi-strings-using-c-interop"></a>如何：封送 ANSI 字符串使用C++互操作

本主题演示如何 ANSI 字符串类型可以是使用传递C++互操作，但.NET Framework<xref:System.String>表示以 Unicode 格式的字符串，因此为 ANSI 的转换是一个额外的步骤。 有关与其他字符串类型进行互操作，请参阅以下主题：
