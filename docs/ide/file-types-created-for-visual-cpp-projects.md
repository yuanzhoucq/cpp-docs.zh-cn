...
|.idl|编译|接口定义语言文件。 有关详细信息，请参阅 Windows SDK 中的[接口定义 (IDL) 文件](https://msdn.microsoft.com/library/windows/desktop/aa378712)。|  
...
|.sln|解决方案|解决方案文件[](https://msdn.microsoft.com/a45c299d-69f5-4b67-879d-1383417df0a7)。|  
|.suo|解决方案|解决方案选项文件。|  
