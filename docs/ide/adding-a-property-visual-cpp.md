...
1. 从快捷菜单中，单击“添加”，然后单击“添加属性”。

1. 在[添加属性向导](../ide/names-add-property-wizard.md)中，提供创建属性的信息。

1. 在向导的 [IDL 特性](../ide/idl-attributes-add-property-wizard.md)页中，为此属性指定任何接口定义语言 (IDL) 设置。
...
[编辑 COM 接口](../ide/editing-a-com-interface.md)<br>
