...
在此过程中，可以键入自己的 Visual C++ 程序或采用示例程序之一。 我们在此过程中使用的示例程序创建了名为“textfile.txt”的文本文件，并将其保存到项目目录。
...
上一步：[演练：在命令行上编译本机 C++ 程序](../build/walkthrough-compiling-a-native-cpp-program-on-the-command-line.md)<br/>
下一步：[演练：在命令行上编译 C 程序](../build/walkthrough-compile-a-c-program-on-the-command-line.md)<br/>
