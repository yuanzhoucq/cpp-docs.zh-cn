...
1. 单击快捷菜单中的“添加”，然后单击“实现接口”以显示[实现接口向导](../ide/implement-interface-wizard.md)。

1. 从适当的类型库中选择要实现的接口，然后单击“完成”。

1. 在类视图中，展开对象的基项和接口节点以查看已实现的接口，然后展开接口节点以查看其可用属性、方法和事件。
