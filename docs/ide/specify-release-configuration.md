---
title: 根据现有代码发布配置新建项目 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-ide
...
使用“从现有代码文件创建新项目”向导的此页指定发布配置项目设置。
...
- **与调试配置相同**
   ...
   指定向导将生成与调试配置项目设置相同的发布配置项目设置。 默认情况下，此选项处于选中状态。 除非取消选中此框，否则此页上的所有其他选项都处于非活动状态。

- **生成命令行**

   指定生成新项目的命令行。 输入编译器的名称以及要用于生成新项目的任何开关或参数。 如果在“指定项目设置”页中选择了“使用外部生成系统”选项，则启用此选项。

- **重新生成命令行**

   指定重新生成新项目的命令行。 如果在“指定项目设置”页中选择了“使用外部生成系统”选项，则启用此选项。

- **清除命令行**

   指定命令行以删除由新项目的生成工具所生成的支持文件。 如果在“指定项目设置”页中选择了“使用外部生成系统”选项，则启用此选项。

- **输出(用于调试)**

   指定新项目“调试”配置的输出文件的目录路径。 如果在“指定项目设置”页中选择了“使用外部生成系统”选项，则启用此选项。
