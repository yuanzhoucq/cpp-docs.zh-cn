...
## <a name="see-also"></a>请参阅  
 ...
 [不在生成中： 选择一个部署策略](http://msdn.microsoft.com/en-us/ecd632d8-063c-4028-b785-81bba045107b)   
 [Windows 安装程序部署概述](http://msdn.microsoft.com/en-us/3ce4610a-b54f-404e-b650-42f4a55dfc3b)   
