...
# [Visual C++ 中的 CMake 和其他非 MSBuild 项目](non-msbuild-projects.md)
## [Visual C++ 中的 CMake 项目](cmake-tools-for-visual-cpp.md)
# [Visual C++ 中的 MSBuild 项目](creating-and-managing-visual-cpp-projects.md)
