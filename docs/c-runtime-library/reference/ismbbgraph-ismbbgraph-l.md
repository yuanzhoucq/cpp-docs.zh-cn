...
为非零*c*，或者，如果它不是 0。 **_ismbbgraph**的任何区域设置相关行为使用当前区域设置。 **_ismbbgraph_l**是完全相同，只不过它改用已传入的区域设置。 有关详细信息，请参阅 [Locale](../../c-runtime-library/locale.md)。
