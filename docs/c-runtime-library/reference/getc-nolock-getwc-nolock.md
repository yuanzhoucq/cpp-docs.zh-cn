...
ms.workload:
- cplusplus
ms.openlocfilehash: ac0396cc4f0112f894d3307343359d3a328dc772
...
这些函数是等于**getc**和**getwc**之处在于它们未锁定调用线程。 它们可能更快，因为它们不会产生锁定其他线程的开销。 仅在线程安全的上下文中使用这些函数，如单线程应用程序或调用范围已经处理线程隔离。
