...
此 POSIX 函数已弃用。  使用 ISO C\+\+ 一致性 [\_putenv](../../c-runtime-library/reference/putenv-wputenv.md) 或增强了安全性的 [\_putenv\_s](../../c-runtime-library/reference/putenv-s-wputenv-s.md)。  
