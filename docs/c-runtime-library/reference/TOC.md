...
## [_ASSERT、_ASSERTE、_ASSERT_EXPR 宏](assert-asserte-assert-expr-macros.md)
...
## [fegetround、fesetround](fegetround-fesetround2.md)
...
## [浮点基元](floating-point-primitives.md)
...
## [fopen、_wfopen_wfopen](fopen-wfopen.md)
...
## [itoa、_itoa、ltoa、_ltoa、ultoa、_ultoa、_i64toa、_ui64toa、_itow、_ltow、_ultow、_i64tow、_ui64tow](itoa-itow.md)
...
## [_mbclen、mblen、_mblen_l、_mbclen_l](mbclen-mblen-mblen-l.md)
...
## [_RPT、_RPTF、_RPTW、_RPTFW 宏](rpt-rptf-rptw-rptfw-macros.md)
