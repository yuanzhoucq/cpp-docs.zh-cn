...
**_Itoa**、 **_ltoa**、 **_ultoa**、 **_i64toa**和 **_ui64toa**函数将给定*值*参数的数字转换为以 null 结尾的字符串, 并存储结果 (最多33个字符用于 **_itoa)** 、 **_ltoa**和 **_ultoa**以及 65, 用于 **_i64toa**和 **_ui64toa**)。 如果*基数*等于10并且*值*为负, 则存储字符串的第一个字符为减号 ( **-** )。 **_Itow**、 **_ltow**、 **_ultow**、 **_i64tow**和 **_ui64tow**函数分别是 **_itoa**、 **_ltoa**、 **_ultoa**、 **_i64toa**和 **_ui64toa**的宽字符版本。
