...
*start*<br/>
指向源字符串中任意字符（ **_mbsdec_l** **_mbsdec**或任意多字节字符的第一个字节）的任何字符的指针;*开始*必须在源字符串中的*当前*之前。

*当前*<br/>
指向源字符串中任意字符（ **_mbsdec_l** **_mbsdec**或任意多字节字符的第一个字节）的任何字符的指针;*当前*必须在源字符串中的*开始时间*之后。
