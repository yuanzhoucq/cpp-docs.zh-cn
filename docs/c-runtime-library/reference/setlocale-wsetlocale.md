...
|`_tsetlocale`|`setlocale`|`setlocale`|`_wsetlocale`|  
 ...
 将区域设置设定为由 *\<language>*、*\<country>* 和 *<code_page>* 字符串指示的语言、国家/地区和代码页。 你可以使用语言、国家/地区和代码页的各种组合。 例如，此调用会将区域设置设定为“法语(加拿大)”并使用代码页 1252：  
