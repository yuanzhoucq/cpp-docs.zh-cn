...
在缓冲区之间复制字节。  提供这些函数的更多安全版本；请参阅 [memcpy\_s、wmemcpy\_s](../../c-runtime-library/reference/memcpy-s-wmemcpy-s.md)。  
...
> [!IMPORTANT]
>  确保目标缓冲区等于或大于源缓冲区。  有关更多信息，请参见[避免缓冲区溢出](http://msdn.microsoft.com/library/windows/desktop/ms717795)。  
...
## 示例  
 有关如何使用 [memmove](../../c-runtime-library/reference/memmove-wmemmove.md) 的示例，请参阅 `memcpy`。  
