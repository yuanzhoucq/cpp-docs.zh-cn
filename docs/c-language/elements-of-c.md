...
该部分还包括[三元组](../c-language/trigraphs.md)、[浮点常量限制](../c-language/limits-on-floating-point-constants.md)、[C 和 C++ 整数限制](../c-language/cpp-integer-limits.md)和[转义序列](../c-language/escape-sequences.md)的引用表。
