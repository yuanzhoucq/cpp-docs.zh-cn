...
ms.locfileid: "73965469"
---
# <a name="pragmas"></a>杂注

**ANSI 3.8.6** 每个识别的 #pragma 指令的行为。

以下 [C 杂注](../c-language/c-pragmas.md)是为 Microsoft C 编译器定义的：
...
|[auto_inline](../preprocessor/auto-inline.md)|[函数](../preprocessor/function-c-cpp.md)|[intrinsic](../preprocessor/intrinsic.md)|[warning](../preprocessor/warning.md)|
