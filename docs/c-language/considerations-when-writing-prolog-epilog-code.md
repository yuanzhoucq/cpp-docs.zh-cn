...
ms.locfileid: "81334583"
---
# <a name="considerations-when-writing-prologepilog-code"></a>编写 Prolog/Epilog 代码时的注意事项

**微软特定**

在编写自己的 prolog 和 epilog 代码序列之前，了解堆栈帧的布局非常重要。了解如何使用预定义常量 **__LOCAL_SIZE**也很有用。

## <a name="cstack-frame-layout"></a><a name="_clang_c_stack_frame_layout"></a>CStack 框架布局
...
## <a name="the-__local_size-constant"></a><a name="_clang_the___local_size_constant"></a> __LOCAL_SIZE 常量
