...
函数范围 标签是唯一一种具有函数范围的标识符。 通过在语句中使用标签来隐式声明标签。 标签名称在函数中必须是唯一的。 （有关标签和标签名称的详细信息，请参阅 [goto 和 Labeled 语句](../c-language/goto-and-labeled-statements-c.md)。）
