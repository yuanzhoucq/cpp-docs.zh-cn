...
"*section 类*" \
可有可无已忽略，但包含它是为了兼容早于版本2.0 的 Microsoft c + + 版本。
...
您还可以为初始化的数据（[data_seg](../preprocessor/data-seg.md)）、未初始化的数据（[bss_seg](../preprocessor/bss-seg.md)）和函数（[code_seg](../preprocessor/code-seg.md)）指定节。
