...
预处理器语句使用的字符集与源文件语句的相同，只不过转义序列不受支持。 预处理器语句中使用的字符集等同于[执行字符集](http://msdn.microsoft.com/a7901c61-524d-47c6-beb6-d9dacc2e72ed)。 预处理器还可识别负字符值。
