...
|名称|描述|  
|--------|--------|  
|[double\_3::double\_3 构造函数](../Topic/double_3::double_3%20Constructor.md)|已重载。  默认构造函数，初始化 0 的所有元素。|  
...
|名称|描述|  
|--------|--------|  
|[double\_3::size 常量](../Topic/double_3::size%20Constant.md)||  
