...
|名称|描述|  
|--------|--------|  
|[unorm\_3::unorm\_3 构造函数](../Topic/unorm_3::unorm_3%20Constructor.md)|已重载。  默认构造函数，初始化 0 的所有元素。|  
...
|名称|描述|  
|--------|--------|  
|[unorm\_3::size 常量](../Topic/unorm_3::size%20Constant.md)||  
