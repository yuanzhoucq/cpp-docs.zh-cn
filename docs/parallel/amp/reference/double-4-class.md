...
|名称|描述|  
|--------|--------|  
|[double\_4::double\_4 构造函数](../Topic/double_4::double_4%20Constructor.md)|已重载。  默认构造函数，初始化 0 的所有元素。|  
...
|名称|描述|  
|--------|--------|  
|[double\_4::size 常量](../Topic/double_4::size%20Constant.md)||  
