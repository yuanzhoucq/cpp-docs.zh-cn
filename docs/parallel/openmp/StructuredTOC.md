...
### [1.5 Normative References](TocOutOfQuery)
### [1.6 Organization](1-6-organization.md)
## [2. Directives](2-directives.md)
### [2.1 Directive Format](TocOutOfQuery)
...
### [2.5 Combined Parallel Work-sharing Constructs](TocOutOfQuery)
#### [2.5.1 parallel for Construct](TocOutOfQuery)
...
#### [3.2.2 omp_destroy_lock and omp_destroy_nest_lock Functions](TocOutOfQuery)
#### [3.2.3 omp_set_lock and omp_set_nest_lock Functions](TocOutOfQuery)
#### [3.2.4 omp_unset_lock and omp_unset_nest_lock Functions](TocOutOfQuery)
#### [3.2.5 omp_test_lock and omp_test_nest_lock Functions](TocOutOfQuery)
### [3.3 Timing Routines](3-3-timing-routines.md)
#### [3.3.1 omp_get_wtime Function](3-3-1-omp-get-wtime-function.md)
#### [3.3.2 omp_get_wtick Function](TocOutOfQuery)
## [4. Environment Variables](TocOutOfQuery)
### [4.1 OMP_SCHEDULE](4-1-omp-schedule.md)
### [4.2 OMP_NUM_THREADS](4-2-omp-num-threads.md)
### [4.3 OMP_DYNAMIC](4-3-omp-dynamic.md)
### [4.4 OMP_NESTED](TocOutOfQuery)
## [A. Examples](TocOutOfQuery)
...
### [A.4   Using the nowait Clause](TocOutOfQuery)
...
### [A.9   Using single Directives](TocOutOfQuery)
### [A.10   Specifying Sequential Ordering](TocOutOfQuery)
...
### [A.16   Using Locks](TocOutOfQuery)
...
### [A.23   Examples of the ordered Directive](TocOutOfQuery)
### [A.24   Example of the private Clause](TocOutOfQuery)
...
### [A.27   Use of C99 Variable Length Arrays](TocOutOfQuery)
### [A.28   Use of num_threads Clause](TocOutOfQuery)
...
### [A.30   Use of Reprivatization](TocOutOfQuery)
...
## [C. OpenMP C and C++ Grammar](TocOutOfQuery)
### [C.1 Notation](c-1-notation.md)
### [C.2 Rules](TocOutOfQuery)
## [D. Using the schedule Clause](d-using-the-schedule-clause.md)
## [E. Implementation-Defined Behaviors in OpenMP C/C++](TocOutOfQuery)
