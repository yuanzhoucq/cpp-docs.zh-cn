...
[1. 介绍](../../parallel/openmp/1-introduction.md)  
 ...
 [1.2 术语的定义](../../parallel/openmp/1-2-definition-of-terms.md)  
  
 [1.3 执行模型](../../parallel/openmp/1-3-execution-model.md)  
  
 [1.4 遵从性](../../parallel/openmp/1-4-compliance.md)  
  
 [1.5 规范引用](../../parallel/openmp/1-5-normative-references.md)  
 ...
 [A.1 并行执行简单的循环](../../parallel/openmp/a-1-executing-a-simple-loop-in-parallel.md)  
  
 [A.2 指定条件编译](../../parallel/openmp/a-2-specifying-conditional-compilation.md)  
  
 [使用并行区域 A.3](../../parallel/openmp/a-3-using-parallel-regions.md)  
  
 [A.4 使用 nowait 子句](../../parallel/openmp/a-4-using-the-nowait-clause.md)  
  
 [A.5 使用关键指令](../../parallel/openmp/a-5-using-the-critical-directive.md)  
 ...
 [指定并行部分 A.8](../../parallel/openmp/a-8-specifying-parallel-sections.md)  
  
 [A.9 使用单个指令](../../parallel/openmp/a-9-using-single-directives.md)  
  
 [指定顺序排序的 A.10](../../parallel/openmp/a-10-specifying-sequential-ordering.md)  
  
 [指定固定的数量的线程的 A.11](../../parallel/openmp/a-11-specifying-a-fixed-number-of-threads.md)  
  
 [A.12 使用原子指令](../../parallel/openmp/a-12-using-the-atomic-directive.md)  
  
 [A.13 刷新指令使用列表](../../parallel/openmp/a-13-using-the-flush-directive-with-a-list.md)  
  
 [A.14 使用不带列表刷新指令](../../parallel/openmp/a-14-using-the-flush-directive-without-a-list.md)  
  
 [A.15 确定使用的线程数](../../parallel/openmp/a-15-determining-the-number-of-threads-used.md)  
  
 [A.16 使用锁](../../parallel/openmp/a-16-using-locks.md)  
  
 [使用 Nestable A.17 锁定](../../parallel/openmp/a-17-using-nestable-locks.md)  
  
 [A.18 嵌套的 for 指令](../../parallel/openmp/a-18-nested-for-directives.md)  
  
 [显示不正确的工作共享指令的嵌套的 A.19 示例](../../parallel/openmp/a-19-examples-showing-incorrect-nesting-of-work-sharing-directives.md)  
  
 [屏障指令 A.20 绑定](../../parallel/openmp/a-20-binding-of-barrier-directives.md)  
  
 [A.21 private 子句作用域变量](../../parallel/openmp/a-21-scoping-variables-with-the-private-clause.md)  
  
 [A.22 使用 default(none) 子句](../../parallel/openmp/a-22-using-the-default-none-clause.md)  
  
 [有序指令 A.23 示例](../../parallel/openmp/a-23-examples-of-the-ordered-directive.md)  
  
 [Private 子句 A.24 示例](../../parallel/openmp/a-24-example-of-the-private-clause.md)  
  
 [Copyprivate 数据属性子句 A.25 示例](../../parallel/openmp/a-25-examples-of-the-copyprivate-data-attribute-clause.md)  
  
 [A.26 使用 threadprivate 指令](../../parallel/openmp/a-26-using-the-threadprivate-directive.md)  
  
 [C99 可变长度数组 A.27 使用](../../parallel/openmp/a-27-use-of-c99-variable-length-arrays.md)  
  
 [Num_threads 子句 A.28 使用](../../parallel/openmp/a-28-use-of-num-threads-clause.md)  
  
 [A.29 使用的工作共享构造内 critical 构造](../../parallel/openmp/a-29-use-of-work-sharing-constructs-inside-a-critical-construct.md)  
  
 [Reprivatization A.30 使用](../../parallel/openmp/a-30-use-of-reprivatization.md)  
  
 [A.31 线程安全锁定函数](../../parallel/openmp/a-31-thread-safe-lock-functions.md)  
