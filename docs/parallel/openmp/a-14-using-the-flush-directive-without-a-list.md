---
title: A.14 使用不带列表的 flush 指令 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
ms.locfileid: "46420733"
---
# <a name="a14---using-the-flush-directive-without-a-list"></a>A.14   使用不带列表的 flush 指令

下面的示例 (对于[部分 2.6.5](../../parallel/openmp/2-6-5-flush-directive.md)第 20 页上) 将受影响的共享的对象区分开来`flush`指令与不受影响的共享对象中没有列表：
