...
> [!IMPORTANT]
> 任务计划程序在通用 Windows 平台（UWP）应用中不可用。 有关详细信息，请参阅[在中C++为 UWP 应用创建异步操作](../../parallel/concrt/creating-asynchronous-operations-in-cpp-for-windows-store-apps.md)。
>
