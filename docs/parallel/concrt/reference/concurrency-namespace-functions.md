...
### <a name="remarks"></a>备注  
 多个后续调用此方法将返回同一实例的资源管理器。 每次调用此方法会递增引用计数在资源管理器中，并必须通过调用匹配[iresourcemanager:: Release](http://msdn.microsoft.com/en-us/5d1356ec-fbd3-4284-a361-1e9e20bbb522)方法完成你的计划程序时使用资源管理器进行通信。  
