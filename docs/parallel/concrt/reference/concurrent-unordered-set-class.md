...
#### <a name="parameters"></a>参数  
 ...
 `_Allocator_type`  
 表示存储的分配器对象封装有关分配和解除分配并发无序集的内存的详细信息的类型。 此参数为可选参数，默认值为 `std::allocator<K>`。  
...
|[insert](#insert)|已重载。 添加到元素`concurrent_unordered_set`对象。|  
|[key_eq](#key_eq)|返回存储的相等性比较函数对象。|  
|[swap](#swap)|交换两个内容`concurrent_unordered_set`对象。 此方法不是并发安全。|  
|[unsafe_erase](#unsafe_erase)|已重载。 从其中移除元素`concurrent_unordered_set`指定位置处。 此方法不是并发安全。|  
  
### <a name="public-operators"></a>公共运算符  
  
|名称|描述|  
|----------|-----------------|  
|[operator=](#operator_eq)|已重载。 将分配的另一个内容`concurrent_unordered_set`于此对象。 此方法不是并发安全。|  
...
##  <a name="operator_eq"></a> 运算符 = 
 ...
 将分配的另一个内容`concurrent_unordered_set`于此对象。 此方法不是并发安全。  
...
##  <a name="swap"></a> 交换 
 ...
 交换两个内容`concurrent_unordered_set`对象。 此方法不是并发安全。  
...
##  <a name="unsafe_erase"></a> unsafe_erase 
 ...
 从其中移除元素`concurrent_unordered_set`指定位置处。 此方法不是并发安全。  
