...
helpviewer_keywords: 
  ...
  - "_InterlockedDecrement_acq 内部函数"
  - "_InterlockedDecrement_nf 内部函数"
  - "_InterlockedDecrement_rel 内部函数"
  - "_InterlockedDecrement16 内部函数"
  - "_InterlockedDecrement16_acq 内部函数"
  - "_InterlockedDecrement16_nf 内部函数"
  - "_InterlockedDecrement16_rel 内部函数"
  - "_InterlockedDecrement64 内部函数"
  - "_InterlockedDecrement64_acq 内部函数"
  - "_InterlockedDecrement64_nf 内部函数"
  - "_InterlockedDecrement64_rel 内部函数"
  - "InterlockedDecrement 内部函数"
  - "InterlockedDecrement_acq 内部函数"
  - "InterlockedDecrement_rel 内部函数"
  - "InterlockedDecrement16 内部函数"
  - "InterlockedDecrement64 内部函数"
  - "InterlockedDecrement64_acq 内部函数"
  - "InterlockedDecrement64_rel 内部函数"
...
**Microsoft 专用**  
 ...
 为 Win32 [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)] [InterlockedDecrement](http://msdn.microsoft.com/library/ms683580.aspx) 函数提供编译器内部支持。  
