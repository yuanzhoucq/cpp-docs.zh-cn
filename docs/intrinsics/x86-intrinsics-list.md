...
ms.locfileid: "59982390"
---
# <a name="x86-intrinsics-list"></a>x86 内部函数列表

本文档列出了内部函数的 Microsoft C /C++编译器在面向 x86 时支持。
...
|[_andn_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_andn_u32)|BMI [1]|ammintrin.h|无符号 int _andn_u32 （无符号的 int、 unsigned 的 int）|
...
|[_InterlockedExchangePointer_HLERelease](interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void \* _InterlockedExchangePointer_HLERelease (void\*易失性\*，void \*)|
...
|[_mm_monitor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_monitor)|SSE3|intrin.h|void _mm_monitor void const *、 无符号的整数 (无符号的整数）|
...
|[_mm_setr_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_setr_pi16)|MMX|intrin.h|__m64 _mm_setr_pi16 （短、 short、 短、 短）|
...
|[__readfsdword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|无符号长 __readfsdword(unsigned long)|
|[__readfsword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|无符号短 __readfsword(unsigned long)|
...
|[__writefsword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsword (无符号 long、 unsigned short)|
