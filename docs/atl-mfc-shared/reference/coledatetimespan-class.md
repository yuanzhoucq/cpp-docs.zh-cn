---
title: COleDateTimeSpan 类 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|[运算符 double](#operator_double)|将此转换`COleDateTimeSpan`值设为**double**。|  
...
##  <a name="operator_double"></a>  COleDateTimeSpan::operator 双精度  
