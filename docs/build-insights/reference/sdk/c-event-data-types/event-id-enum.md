---
title: EVENT_ID 枚举
description: C++生成见解 SDK EVENT_ID 枚举引用。
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "78335218"
---
# <a name="event_id-enum"></a>EVENT_ID 枚举
...
| `EVENT_ID_COMPILER` | 7（0x00000007） | [编译程序](../event-table.md#compiler) |
...
| `EVENT_ID_LINKER` | 18（0x00000012） | [器](../event-table.md#linker) |
...
| `EVENT_ID_PASS1` | 24（0x00000018） | [PASS1.LOG](../event-table.md#pass1) |
