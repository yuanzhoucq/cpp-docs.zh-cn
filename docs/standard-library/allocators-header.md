...
|||  
|-|-|  
|[operator!= (\<allocators>)](../standard-library/allocators-operators.md#operator_neq)|测试指定类的分配器对象之间是否不相等。|  
|[operator== (\<allocators>)](../standard-library/allocators-operators.md#operator_eq_eq)|测试指定类的分配器对象之间是否相等。|  
