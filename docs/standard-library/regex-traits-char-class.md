...
ms.locfileid: "72686681"
---
# <a name="regex_traitsltchargt-class"></a>regex_traits&lt;char&gt; 类

**Char**的 `regex_traits` 专用化。
...
类是[regex_traits](../standard-library/regex-traits-class.md)类型的元素的类模板的显式专用**化（以便**它可以充分利用操作此类型对象的库函数）。
