...
ms.locfileid: "72688281"
---
# <a name="ltcodecvtgt"></a>&lt;codecvt&gt;

定义了多个类模板，用于描述基于类模板[codecvt](../standard-library/codecvt-class.md)的对象。 这些对象可用作[区域设置 facet](../standard-library/locale-class.md#facet_class) ，它们控制类型的值序列之间的转换 `Elem` 与**char**类型的值序列。
