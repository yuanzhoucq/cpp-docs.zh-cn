...
## <a name="boyer-moore-horspool-searcher-constructor"></a>boyer_moore_horspool_searcher 构造函数

使用序列搜索、哈希函数对象和相等谓词来构造函数对象。`boyer_moore_horspool_searcher`
