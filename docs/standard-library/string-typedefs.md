...
一种类型, 该类型描述模板类的专用化[basic_string](../standard-library/basic-string-class.md)与**char**类型的元素。
...
一种类型, 该类型描述模板类的专用化[basic_string](../standard-library/basic-string-class.md)与**wchar_t**类型的元素。
