...
一种类型，该类型描述与**char**类型的元素[basic_string](../standard-library/basic-string-class.md)的类模板的专用化。
...
一种类型，该类型使用 `char16_t`类型的元素来描述类[basic_string](../standard-library/basic-string-class.md)模板的专用化。
...
一种类型，该类型使用 `char32_t`类型的元素来描述类[basic_string](../standard-library/basic-string-class.md)模板的专用化。
...
一种类型，该类型使用**wchar_t**类型的元素来描述类[basic_string](../standard-library/basic-string-class.md)模板的专用化。
...
> [!NOTE]
> **Wchar_t**的大小是由实现定义的。 如果代码依赖于**wchar_t**一定大小，请检查平台的实现（例如，使用 `sizeof(wchar_t)`）。 如果需要保证宽度在所有平台上一致的字符串字符类型，请使用 [string](../standard-library/string-typedefs.md#string)、[u16string](../standard-library/string-typedefs.md#u16string) 或 [u32string](../standard-library/string-typedefs.md#u32string)。
