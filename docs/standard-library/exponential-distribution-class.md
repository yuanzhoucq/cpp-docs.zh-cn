---
title: exponential_distribution 类 | Microsoft 文档
ms.custom: ''
ms.date: 11/04/2016
ms.reviewer: ''
ms.suite: ''
...
ms.workload:
- cplusplus
ms.openlocfilehash: 56440fa0948b89e3467edbffb2cfc670830f1168
...
有关指数分布的详细信息，请参阅 Wolfram MathWorld 文章[指数分布](http://go.microsoft.com/fwlink/p/?linkid=401098)。
