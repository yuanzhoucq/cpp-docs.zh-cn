...
## <a name="classification--comparison-functions"></a>分类/比较函数
...
### <a name="associated-legendre-functions"></a>关联的 Legendre 函数
...
### <a name="complete-elliptic-integral-of-the-first-kind"></a>完整的第一类椭圆整型
...
### <a name="complete-elliptic-integral-of-the-second-kind"></a>完成第二种类型的椭圆整数
...
### <a name="complete-elliptic-integral-of-the-third-kind"></a>第三种类型的完整椭圆整型
...
### <a name="regular-modified-cylindrical-bessel-functions"></a>定期修改的圆柱形贝赛耳函数
...
### <a name="cylindrical-bessel-functions-of-the-first-kind"></a>第一种情况的圆柱形贝赛耳函数
...
### <a name="irregular-modified-cylindrical-bessel-functions"></a>不规则修改的圆柱形贝赛耳函数
...
### <a name="cylindrical-neumann-functions"></a>圆柱形 Neumann 函数
...
### <a name="incomplete-elliptic-integral-of-the-first-kind"></a>第一种类型的椭圆整数不完整
...
### <a name="incomplete-elliptic-integral-of-the-second-kind"></a>第二种类型的不完整椭圆整型
...
### <a name="incomplete-elliptic-integral-of-the-third-kind"></a>第三种类型的不完整椭圆整数
...
### <a name="spherical-bessel-functions-of-the-first-kind"></a>第一种的球面贝赛耳函数
...
### <a name="spherical-associated-legendre-functions"></a>球状关联的 Legendre 函数
...
### <a name="spherical-neumann-functions"></a>球状 Neumann 函数
