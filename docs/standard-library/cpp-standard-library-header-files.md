...
C++ 标准库和扩展名的标头文件（按类别）。  
 ...
 `Algorithms` [[详细信息](../cpp/algorithms-modern-cpp.md)]  
 ...
 `Containers` [[详细信息](../cpp/containers-modern-cpp.md)]  
 `Sequence`  
 ...
 `Error Handling` [[详细信息](../cpp/errors-and-exception-handling-modern-cpp.md)]  
 ...
 `Input/Output` [[详细信息](../cpp/string-and-i-o-formatting-modern-cpp.md)]  
 ...
 `Memory Management` [[详细信息](../cpp/smart-pointers-modern-cpp.md)]  
