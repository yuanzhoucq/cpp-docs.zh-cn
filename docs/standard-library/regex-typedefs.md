...
该类型描述 `const char*`类型的迭代器[match_results](../standard-library/match-results-class.md)类的专用化。
...
该类型描述 `const char*`类型的迭代器[regex_iterator](../standard-library/regex-iterator-class.md)类的专用化。
...
该类型描述 `const char*`类型的迭代器[regex_token_iterator](../standard-library/regex-token-iterator-class.md)类的专用化。
...
该类型描述 `const char*`类型的迭代器[sub_match](../standard-library/sub-match-class.md)类的专用化。
...
该类型描述了类模板[Basic_regex 类](../standard-library/basic-regex-class.md)的专用化类型为**char**的元素。
...
该类型描述 `string::const_iterator`类型的迭代器[match_results](../standard-library/match-results-class.md)类的专用化。
...
该类型描述 `string::const_iterator`类型的迭代器[regex_iterator](../standard-library/regex-iterator-class.md)类的专用化。
...
该类型描述 `string::const_iterator`类型的迭代器[regex_token_iterator](../standard-library/regex-token-iterator-class.md)类的专用化。
...
该类型描述 `string::const_iterator`类型的迭代器[sub_match](../standard-library/sub-match-class.md)类的专用化。
...
该类型描述 `const wchar_t*`类型的迭代器[match_results](../standard-library/match-results-class.md)类的专用化。
...
该类型描述 `const wchar_t*`类型的迭代器[regex_iterator](../standard-library/regex-iterator-class.md)类的专用化。
...
该类型描述 `const wchar_t*`类型的迭代器[regex_token_iterator](../standard-library/regex-token-iterator-class.md)类的专用化。
...
该类型描述 `const wchar_t*`类型的迭代器[sub_match](../standard-library/sub-match-class.md)类的专用化。
...
该类型描述类模板[Basic_regex 类](../standard-library/basic-regex-class.md) **wchar_t**类型的元素的专用化。
...
该类型描述 `wstring::const_iterator`类型的迭代器[match_results](../standard-library/match-results-class.md)类的专用化。
...
该类型描述 `wstring::const_iterator`类型的迭代器[regex_iterator](../standard-library/regex-iterator-class.md)类的专用化。
...
该类型描述 `wstring::const_iterator`类型的迭代器[regex_token_iterator](../standard-library/regex-token-iterator-class.md)类的专用化。
...
该类型描述 `wstring::const_iterator`类型的迭代器[sub_match](../standard-library/sub-match-class.md)类的专用化。
