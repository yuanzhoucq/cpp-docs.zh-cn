...
`left` C 样式字符串或类型的对象`basic_string`要连接。

`right` C 样式字符串或类型的对象`basic_string`要连接。
...
`left` C 样式字符串或类型的对象`basic_string`进行比较。

`right` C 样式字符串或类型的对象`basic_string`进行比较。
