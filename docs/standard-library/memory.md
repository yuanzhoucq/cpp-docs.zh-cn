...
|[破坏](../standard-library/memory-functions.md#destroy)|简写 `destroy` 方法。|
...
|[运算符>=](../standard-library/memory-operators.md#op_gt_eq)|测试指定类的某一分配器对象是否大于或等于另一个分配器对象。|
|[运算符<](../standard-library/memory-operators.md#op_lt)|测试指定类的某一对象是否小于另一个对象。|
|[操作员\<=](../standard-library/memory-operators.md#op_gt_eq)|测试指定类的某一对象是否小于或等于另一个对象。|
|[运算符>](../standard-library/memory-operators.md#op_gt)|测试指定类的某一对象是否大于另一个对象。|
|[运算符<<](../standard-library/memory-operators.md#op_lt_lt)|`shared_ptr` 插入器。|
...
|hash|提供专用于和的重载 `unique_ptr` `shared_ptr` 。|
