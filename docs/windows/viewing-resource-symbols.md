...
1.  在[资源视图](../windows/resource-view-window.md)中，右键单击 .rc 文件。  
  
    > [!NOTE]
    >  如果你的项目尚未包含 .rc 文件，请参阅[创建新的资源脚本文件](../windows/how-to-create-a-resource-script-file.md)。  
  
2.  从快捷菜单中选择**“资源符号”**以在[“资源符号”对话框](../windows/resource-symbols-dialog-box.md)中查看资源符号表。  
  
    > [!NOTE]
    >  若要查看预定义符号，请选中**“显示只读符号”**复选框。  
