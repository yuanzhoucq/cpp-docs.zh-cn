...
|特性|描述|
|---------------|-----------------|
|[COM 特性](../windows/com-attributes.md)|注入的代码来支持 COM 开发和.NET Framework 公共语言运行时开发的许多方面。|
|[IDL 特性](../windows/idl-attributes.md)|启用从一个源代码文件，而不使用向导或不包含结构的知识和该文件的语法的.idl 文件的修改。|
