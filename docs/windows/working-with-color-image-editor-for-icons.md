...
- 若要显示**颜色**窗口中，右键单击**图像编辑器**窗格，然后选择**显示颜色窗口**，或选择**显示颜色窗口**上[图像菜单](../windows/image-menu-image-editor-for-icons.md)。
...
1. 上**的图像编辑器**工具栏 (或使用**映像** > **工具**)，选择**填充**工具。
