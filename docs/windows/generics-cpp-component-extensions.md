 ...
 **Windows 运行时和公共语言运行时支持**  
  
 [Visual C++ 中的泛型概述](../windows/overview-of-generics-in-visual-cpp.md)  
 ...
 [泛型类型参数的约束 (C++/CLI)](../windows/constraints-on-generic-type-parameters-cpp-cli.md)  
 有关在泛型类型中使用约束的信息。  
  
 [使用泛型 (C++/CLI)](../windows/consuming-generics-cpp-cli.md)  
 有关使用 Visual C++ 在 .NET 程序集中定义、可能使用其他语言创作的泛型的信息。  
  
 [泛型和模板 (Visual C++)](../windows/generics-and-templates-visual-cpp.md)  
 比较泛型和模板，分别何时使用以及如何有效地结合使用。  
  
 **支持的公共语言运行时**  
  
 [泛型函数 (C++/CLI)](../windows/generic-functions-cpp-cli.md)  
 有关定义和使用泛型函数和方法的信息。  
...
## <a name="related-sections"></a>相关章节  
 ...
 使用[对于每一个，在](../dotnet/for-each-in.md)泛型集合上的关键字。  
