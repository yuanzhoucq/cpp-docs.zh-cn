...
|名称|描述|  
|----------|-----------------|  
|[DeferrableEventArgs::GetDeferral 方法](../windows/deferrableeventargs-getdeferral-method.md)|获取对[延迟](http://go.microsoft.com/fwlink/p/?linkid=526520)对象该对象表示延迟的事件。|  
