---
title: 设置组合框及其下拉列表的大小 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
[向组合框控件添加值](../windows/adding-values-to-a-combo-box-control.md)<br/>
