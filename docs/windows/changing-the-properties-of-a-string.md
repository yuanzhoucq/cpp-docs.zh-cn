...
### <a name="to-change-a-string-or-its-identifier"></a>若要更改一个字符串或其标识符  
...
2.  选择你想要编辑，并双击的字符串**ID**，**值**，或**标题**列。 现在，你可以：  
  
    -   选择**ID**从**ID 下拉**列表，或直接就地输入 ID。  
    ...
    -   键入中的编辑**标题**列。  
        ...
        > [!NOTE]
        >  你还可以编辑中的字符串属性[属性窗口](/visualstudio/ide/reference/properties-window)。  
