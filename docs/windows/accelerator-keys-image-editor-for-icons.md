...
|图像.下一种颜色|Ctrl **]**  + <br /><br /> -或者-<br /><br /> **Ctrl** + **向右键**|将绘制前景色更改为下一个调色板颜色。|
|Image.NextRightColor|Ctrl**Shift**] +  + <br /><br /> -或者-<br /><br /> **Shift** + **Ctrl** + **右箭头**|将绘制背景色更改为下一个调色板颜色。|
...
|图像.上一种颜色|Ctrl **[**  + <br /><br /> -或者-<br /><br /> **Ctrl** + **向左键**|将绘制前景色更改为以前的调色板颜色。|
|Image.PreviousRightColor|Ctrl**Shift**[ +  + <br /><br /> -或者-<br /><br /> **Shift** + **Ctrl** + **左箭头**|将绘制背景色更改为以前的调色板颜色。|
...
|图像.放大|按**Ctrl** + **Shift** +  **。** （句点）<br /><br /> -或者-<br /><br /> **Ctrl** + **向上箭头**|增加当前视图的放大倍数。|
|图像.缩小|**Ctrl** +  **、** （逗号）<br /><br /> -或者-<br /><br /> **Ctrl** + **向下箭头**|减小当前视图的放大倍数。|
