---
title: "缩小或拉伸图像 （图标的图像编辑器） 的一部分 |Microsoft 文档"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
- cplusplus
- uwp
ms.openlocfilehash: ea7cef1edf04cac83bfacefa881ffca92117caa2
...
1.  选择你想要调整大小的映像的一部分。 有关详细信息，请参阅[选择的映像的区域](../windows/selecting-an-area-of-an-image-image-editor-for-icons.md)。  
  
2.  拖动调整大小控点之一，直到所选内容是所需的大小。  
