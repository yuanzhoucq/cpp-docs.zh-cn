...
> [!NOTE]
> **特性**属性现已弃用。  使用公共语言运行时属性`System.Attribute`到直接来创建用户定义的特性。 有关详细信息，请参阅[用户定义的特性](../user-defined-attributes-cpp-component-extensions.md)。

您定义[自定义特性](custom-attributes-cpp.md)上来**属性**上托管的类或结构定义的属性。 类的名称是自定义属性。 例如：
...
有关可能属性参数类型的列表，请参阅[自定义特性](custom-attributes-cpp.md)。

请参阅[用户定义的特性](../user-defined-attributes-cpp-component-extensions.md)特性目标有关的讨论。
