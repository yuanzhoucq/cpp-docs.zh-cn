...
|[Synclockwithstatust:: Islocked 方法](../windows/synclockwithstatust-islocked-method.md)|指示当前 SyncLockWithStatusT 对象是否拥有资源，则SyncLockWithStatusT 对象即是 *锁定*。|  
  
### <a name="protected-data-members"></a>受保护的数据成员  
  
|名称|描述|  
|----------|-----------------|  
|[Synclockwithstatust:: Status_ 数据成员](../windows/synclockwithstatust-status-data-member.md)|根据当前 SyncLockWithStatusT 对象保存结果的基础等待锁定操作后的操作对象。|  
