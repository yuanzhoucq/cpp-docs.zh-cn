...
3.  右键单击要将资源 (例如，Source2.rc) 粘贴到其中的资源文件。 选择**粘贴**从快捷菜单。  
  
    > [!NOTE]
    >  您不能拖放、 复制、 剪切、 或粘贴项目 （资源视图） 中的资源文件和独立.rc 文件 （即在文档窗口中打开） 之间。 无法在以前版本的产品来执行此操作。  
