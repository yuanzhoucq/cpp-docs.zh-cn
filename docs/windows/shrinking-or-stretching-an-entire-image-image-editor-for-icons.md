---
title: 缩小或拉伸整个图像 （图标的图像编辑器） |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "39646993"
---
# <a name="shrinking-or-stretching-an-entire-image-image-editor-for-icons"></a>缩小或拉伸整个图像（图标的图像编辑器）
### <a name="to-shrink-or-stretch-an-entire-image"></a>若要缩小或拉伸整个图像  
  
1.  选择整个图像。  
  
     如果当前所选映像的一部分，并且你想要选择整个图像，单击任意位置上当前选定内容边框外部图像。  
  
2.  按住**Shift**键并拖动调整大小控点，直到该图像是所需的大小。  
