---
title: "Microsoft::WRL 命名空间 | Microsoft Docs"
ms.custom: ""
ms.date: "12/16/2016"
...
定义构成 [!INCLUDE[cppwrl_short](../windows/includes/cppwrl_short_md.md)] 的基础类型。  
...
|[RuntimeClassType 枚举](../windows/runtimeclasstype-enumeration.md)|指定的类型 [RuntimeClass](../windows/runtimeclass-class.md) 支持的实例。|  
