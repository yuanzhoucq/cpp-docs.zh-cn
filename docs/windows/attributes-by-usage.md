...
本主题列出根据它们应用到的 c + + 语言元素的属性。  
 ...
 如果属性位于之前不在该特性的作用域的 Visual c + + 元素，则在特性块将被视为注释。  
...
|[参数特性](../windows/parameter-attributes.md)|适用于类或接口中的方法的参数。|  
...
|[独立特性](../windows/stand-alone-attributes.md)|起作用更像的代码行，但不对 c + + 关键字进行操作。 独立特性语句需要行尾的分号。|  
