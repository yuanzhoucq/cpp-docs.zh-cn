...
## 备注  
 参见 [如何：直接实例化 WRL 组件](../windows/how-to-instantiate-wrl-components-directly.md) 理解差异此函数\) 和 [Microsoft::WRL::Details::MakeAndInitialize](../windows/make-function.md)之间和的示例。  
