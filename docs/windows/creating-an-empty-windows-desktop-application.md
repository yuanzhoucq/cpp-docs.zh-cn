---
title: "正在创建空的 Windows 桌面应用程序 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
3.  输入新项目的名称以及项目目录的路径，然后单击“确定”。  
  
4.  在 [Win32 应用程序向导](../windows/win32-application-wizard.md)中，单击“应用程序设置”页。 选择要使用源代码文件创建的“应用程序类型”，然后在“附加选项”下选中“空项目”复选框。  
