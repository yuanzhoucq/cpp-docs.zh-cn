...
||**double**|类型**double**是大于或等于**float**类型但小于或等于类型**long double**的大小的浮点类型。<br /><br /> 特定于 Microsoft 的： **long double**和**double**的表示形式相同。 不过，**长双精度**型和**双精度**型是单独的类型。|
...
|类型|大小|
|----------|----------|
|**bool**、 **char**、**无符号 char**、**带符号 char**、 **__int8**|1 字节|
|**__int16**， **short**，**无符号 short**， **wchar_t**， **__wchar_t**|2 字节|
