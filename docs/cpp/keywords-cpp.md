...
ms.locfileid: "83550818"
---
# <a name="keywords-c"></a>关键字 (C++)

关键字是具有特殊意义的预定义保留标识符。 它们不能用作程序中的标识符。 Microsoft C++ 保留了下列关键字。 带前导下划线的名称和后跟（c + +/CLI）的名称是 Microsoft 扩展。
...
|[alignas](align-cpp.md)|[数组](../extensions/arrays-cpp-component-extensions.md)（c + +/cli）|[auto](auto-keyword.md)|[bool](bool-cpp.md)|
...
|[default](switch-statement-cpp.md)|[委托](../extensions/delegate-cpp-component-extensions.md)（c + +/cli）|[delete](delete-operator-cpp.md)|[弃用](deprecated-cpp.md) <sup>1</sup>|
...
|[dynamic_cast](dynamic-cast-operator.md)|[else](if-else-statement-cpp.md)|[enum](enumerations-cpp.md)|[枚举类](../extensions/enum-class-cpp-component-extensions.md)|
...
|[对于每个](../dotnet/for-each-in.md)|[friend](friend-cpp.md)|[friend_as](../preprocessor/hash-using-directive-cpp.md)|[gcnew](../extensions/ref-new-gcnew-cpp-component-extensions.md)（c + +/cli）|
...
|[inline](inline-functions-cpp.md)|[int](fundamental-types-cpp.md)|[接口类](../extensions/interface-class-cpp-component-extensions.md)（c + +/cli）|[接口结构](../extensions/interface-class-cpp-component-extensions.md)（c + +/cli）|
|[interior_ptr](../extensions/interior-ptr-cpp-cli.md)（c + +/cli）|[文本](../extensions/literal-cpp-component-extensions.md)（c + +/cli）|[long](fundamental-types-cpp.md)|[mutable](mutable-data-members-cpp.md)|
|[裸](naked-cpp.md) <sup>1</sup>|[namespace](namespaces-cpp.md)|[新](../extensions/new-new-slot-in-vtable-cpp-component-extensions.md)（c + +/cli）|[new](new-operator-cpp.md)|
...
|[属性](../extensions/property-cpp-component-extensions.md)（c + +/cli）|[属性](property-cpp.md) <sup>1</sup>|[protected](protected-cpp.md)|[public](public-cpp.md)|
...
|[模版](templates-cpp.md)|[this](this-pointer.md)|[线程](thread.md) <sup>1</sup>|[throw](try-throw-and-catch-statements-cpp.md)|
...
|[using](using-declaration.md)声明|[using](namespaces-cpp.md#using_directives)指令|[uuid](uuid-cpp.md) <sup>1</sup>|[值类](../extensions/classes-and-structs-cpp-component-extensions.md)（c + +/cli）|
|[值结构](../extensions/classes-and-structs-cpp-component-extensions.md)（c + +/cli）|[virtual](virtual-cpp.md)|[void](void-cpp.md)|[volatile](volatile-cpp.md)|
|[while](while-statement-cpp.md)|

<sup>1</sup> **__declspec**关键字的扩展属性。

<sup>2</sup>仅适用于 Managed Extensions for C++。 此语法现已弃用。 有关详细信息，请参阅[运行时平台的组件扩展](../extensions/component-extensions-for-runtime-platforms.md)。

<sup>3</sup>事件处理中使用的内部函数。

<sup>4</sup>对于与以前版本的向后兼容性，在启用 Microsoft 扩展（默认值）时，可以使用两个前导下划线和单个前导下划线。
...
启用 Microsoft 扩展后，你可以在程序中使用 Microsoft 特定关键字。 为了符合 ANSI，这些关键字的前面有一条双下划线。 为了向后兼容，支持多个双下划线关键字的单下划线版本。 此外， **__cdecl**可用，没有前导下划线。

**__Asm**关键字替代 c + + `asm` 语法。 保留了 `asm` 以便与其他 C++ 实现兼容，但未成功。 使用 **__asm**。
