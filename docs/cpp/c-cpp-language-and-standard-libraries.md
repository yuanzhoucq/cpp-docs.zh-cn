...
|[C 运行时库参考](../c-runtime-library/c-run-time-library-reference.md)|关于 Microsoft 实现的 C 运行时（CRT）的参考内容。|
|[SafeInt 库](../windows/safeint-library.md)|关于能处理整数溢出情况的库函数的参考内容。|  
|[Visual C++](../visual-cpp-in-visual-studio.md)|描述 Visual C++ 在 Visual Studio 中的主要功能，以及指向其他 Visual C++ 文档的链接。|  
|[IDE 和开发工具](../ide/ide-and-tools-for-visual-cpp-development.md)|指向其他关于如何使用 Visual Studio 及相关工具来创建、编译和部署 C++ 应用程序的文章链接。|  
