...
description: 对任何 c + + 类、结构或联合使用大括号初始化
ms.date: 11/19/2019
...
您可以在通常执行初始化的任何位置（例如，作为函数参数或返回值，或使用关键字）使用大括号初始化 **`new`** ：
...
> [!IMPORTANT]
> 若要使用此类，必须包含 [\<initializer_list>](../standard-library/initializer-list.md) 标头。
