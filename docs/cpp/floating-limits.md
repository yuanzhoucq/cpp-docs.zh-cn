...
|FLT_MAX_10_EXP DBL_MAX_10_EXP LDBL_MAX_10_EXP|最大整数，以便 10 引发的该数字是一个可表示的浮点数。|38 308 308|  
...
|FLT_MIN_10_EXP DBL_MIN_10_EXP LDBL_MIN_10_EXP|最小负整数，以便 10 引发的该数字是可表示的浮点数。|-37<br /><br /> -307<br /><br /> -307|  
