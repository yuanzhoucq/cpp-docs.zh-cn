...
在“单继承”（继承的常见形式）中，类仅具有一个基类。 考虑下图中阐释的关系。  
 ...
 ![基本单 &#45; 继承关系图](../cpp/media/vc38xj1.gif "vc38XJ1")  
简单单继承关系图  
...
```  
 ...
 在前面的示例中，访问说明符**公共**使用。 中介绍了公共的、 受保护的和私有的继承的含义[成员访问控制。](../cpp/member-access-control-cpp.md)  
...
> [!NOTE]
>  有向非循环图对于单继承不是唯一的。 它们还用于表示多重继承关系图。 本主题中介绍了[多重继承](http://msdn.microsoft.com/en-us/3b74185e-2beb-4e29-8684-441e51d2a2ca)。  
