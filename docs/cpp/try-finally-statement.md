...
为了与早期版本兼容， **_try**、 **_finally**和 **_leave**是 **__try**、 **__finally**和 **__leave**的同义词，除非编译器选项[/za \(Disable 语言扩展）](../build/reference/za-ze-disable-language-extensions.md)是规定.
