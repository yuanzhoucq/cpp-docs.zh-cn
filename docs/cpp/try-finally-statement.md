...
&nbsp;&nbsp;&nbsp;&nbsp;尝试语句*compound-statement* *compound-statement* ** \_ \_** finally 复合语句** \_ \_**
...
> [!NOTE]
> Try-finally 的行为不同于支持**最终**使用的其他一些语言，如 c #。  单个 **__try**可以同时具有 **__finally**和 **__except**。  如果同时使用二者，则外部 try-except 语句必须包含内部 try-finally 语句。  指定何时执行每个块的规则也有所不同。
