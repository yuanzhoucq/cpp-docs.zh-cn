...
[内置类型](fundamental-types-cpp.md)C++编译器内置的基本类型及其值范围。
...
[运算符、优先级别和关联性](../cpp/cpp-built-in-operators-precedence-and-associativity.md)<br/>
C++ 中的运算符。
...
模板规范、函数模板、类模板、**类型名称**关键字、模板与宏、模板和智能指针。
