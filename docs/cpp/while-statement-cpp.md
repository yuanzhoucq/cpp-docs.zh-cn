...
当执行语句体中的[break](../cpp/break-statement-cpp.md)、 [goto](../cpp/goto-statement-cpp.md)或[return](../cpp/return-statement-cpp.md)时， **while**循环也可以终止。 使用 "[继续](../cpp/continue-statement-cpp.md)" 可在不退出**while**循环的情况下终止当前迭代。 **继续**将控制传递到**while**循环的下一次迭代。
