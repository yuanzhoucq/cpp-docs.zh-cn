...
|35|[视觉对象使用多个资源文件和头文件C++](../mfc/tn035-using-multiple-resource-files-and-header-files-with-visual-cpp.md)|
...
|16|[使用C++使用 MFC 的多个继承](../mfc/tn016-using-cpp-multiple-inheritance-with-mfc.md)|
