---
title: 创建新文档、 Windows，和视图 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
![创建文档的顺序](../mfc/media/vc387l1.gif "vc387l1")序列中创建文档

![框架窗口创建序列](../mfc/media/vc387l2.png "vc387l2")在框架窗口创建序列

![创建一个视图的顺序](../mfc/media/vc387l3.gif "vc387l3")序列中创建视图
