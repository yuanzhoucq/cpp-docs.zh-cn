...
3.  从快捷菜单中，单击**外**，然后单击**添加属性**。  
  
4.  选择一个从条目**属性名称**下拉列表。 例如，可以选择**文本**。  
  
     因为**文本**一个常用属性**可绑定**并**requestedit**属性已选中。  
  
5.  选中以下复选框从**IDL 特性**选项卡： **displaybind**并**defaultbind**将属性添加到项目的属性定义。IDL 文件。 这些属性使控件对用户可见，并使常用属性的默认可绑定属性。  
...
2.  上**控制设置**页上，选择为子类的控件的窗口类。 例如，您可以为子类的编辑控件。  
