...
ms.locfileid: "62242323"
---
# <a name="creating-the-dialog-resource"></a>创建对话框资源

设计[对话框中](../mfc/dialog-boxes.md)并且创建对话框资源，则使用[对话框编辑器](../windows/dialog-editor.md)。 在对话框编辑器中，您可以：
...
时对话框的外观适合您，创建对话框类并将其消息映射中所述[使用代码向导创建对话框类](../mfc/creating-a-dialog-class-with-code-wizards.md)。
