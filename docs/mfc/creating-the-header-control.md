...
1. 对于需要处理的任何标头控件通知消息, 使用属性窗口在对话框类中映射处理程序函数 (请参阅[将消息映射到函数](../mfc/reference/mapping-messages-to-functions.md))。
...
1. 对于需要处理的任何标头控件通知消息, 使用属性窗口来映射视图类中的处理程序函数 (请参阅[将消息映射到函数](../mfc/reference/mapping-messages-to-functions.md))。
