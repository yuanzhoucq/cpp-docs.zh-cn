...
但是，MFC 库还提供了基于 Windows API 的 C++ 封装构建的其他应用程序功能层。 此层是一个面向 Windows 的工作应用程序框架，可提供针对 Windows 程序的大多数常见用户界面，包括工具栏、状态栏、打印、打印预览、数据库支持和 ActiveX 支持。 [为 Windows 编写应用程序中使用类](../mfc/using-the-classes-to-write-applications-for-windows.md)说明了此框架详细信息。
