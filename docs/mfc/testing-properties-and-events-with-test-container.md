...
1.  上**编辑**测试容器中，菜单上单击**插入新控件**。  
  
2.  在**插入控件**框中，选择所需的控件，然后单击**确定**。 控件将出现在控件容器中。  
  
    > [!NOTE]
    >  如果你的控件未列在**插入控件**对话框框中，请确保你已注册其与**注册控件**命令**文件**测试菜单容器。  
...
2.  在**方法名称**下拉列表中，选择你想要测试的属性的 PropPut 方法。  
  
3.  修改**参数值**或**参数类型**，然后单击**设置值**按钮。  
  
4.  单击**Invoke**将应用于对象的新值。  
