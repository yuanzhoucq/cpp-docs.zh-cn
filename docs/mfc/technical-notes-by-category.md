...
||
|-|
|[TN002：永久性对象数据格式](../mfc/tn002-persistent-object-data-format.md)|
|[TN006：消息映射](../mfc/tn006-message-maps.md)|
|[TN016：结合使用 C++ 多重继承和 MFC](../mfc/tn016-using-cpp-multiple-inheritance-with-mfc.md)|
...
|[TN029：拆分器窗口](../mfc/tn029-splitter-windows.md)|
...
|[TN066：从 MFC 3.x 到 4.0 的常见移植问题](../mfc/tn066-common-mfc-3-x-to-4-0-porting-issues.md)|
...
|[TN047：放宽数据库事务要求](../mfc/tn047-relaxing-database-transaction-requirements.md)|
|[TN048：编写 MFC 数据库应用程序的 ODBC 安装程序和管理程序](../mfc/tn048-writing-odbc-setup-and-administration-programs.md)|
...
|[TN070：MFC 窗口类名](../mfc/tn070-mfc-window-class-names.md)|
