...
2.  在类声明中，使用 DECLARE_DYNAMIC 宏，如下所示：  
  
     [!code-cpp[NVC_MFCCObjectSample#2](../mfc/codesnippet/cpp/specifying-levels-of-functionality_1.h)]  
  
3.  在实现文件中使用 IMPLEMENT_DYNAMIC 宏 (。CPP) 的您的类。 此宏将作为自变量类和其基本类的名称，如下所示：  
  
     [!code-cpp[NVC_MFCCObjectSample#3](../mfc/codesnippet/cpp/specifying-levels-of-functionality_2.cpp)]  
  
> [!NOTE]
>  始终将 IMPLEMENT_DYNAMIC 放在实现文件 (。CPP) 为您的类。 IMPLEMENT_DYNAMIC 宏应在编译期间一次计算，并因此不应使用在接口文件 (。H），可可能包括在多个文件。  
...
4.  在类实现文件中使用 IMPLEMENT_DYNCREATE 宏。  
