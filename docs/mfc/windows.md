...
-   [C + + 之间的关系窗口对象和 HWND 处理](../mfc/relationship-between-a-cpp-window-object-and-an-hwnd.md)  
...
-   [设备上下文](../mfc/device-contexts.md)： 使 Windows 绘制设备无关的对象  
...
-   [多个文档类型、 视图和框架窗口 （拆分窗口）](../mfc/multiple-document-types-views-and-frame-windows.md)  
...
-   [在设备上下文中使用钢笔和其他图形对象](../mfc/graphic-objects.md)  
