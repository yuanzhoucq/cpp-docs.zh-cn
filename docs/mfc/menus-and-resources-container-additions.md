...
如果不使用应用程序向导，您可能想要看一看 OCLIENT。RC 中，资源脚本中的 OCLIENT 示例应用程序，若要了解如何实现这些更改。 请参阅 MFC OLE 示例[OCLIENT](../visual-cpp-samples.md)。
...
第二项更改是创建新的快捷键对应表，对应于创建就地激活的新菜单资源。 此表具有除了上述 VK_ESCAPE 条目的文件和窗口菜单项。 下面的示例是就地激活 MFC 示例中为创建快捷键对应表[容器](../visual-cpp-samples.md):
