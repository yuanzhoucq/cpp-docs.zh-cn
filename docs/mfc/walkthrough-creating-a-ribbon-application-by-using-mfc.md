...
1. 第一页上**MFC 应用程序向导**，单击**下一步**。

1. 上**应用程序类型**页面上，在**视觉样式和颜色**，选择**Office 2007 （蓝色主题）**。 将其他设置保留不变。 单击 **“下一步”**。

1. 上**复合文档支持**页上，请确保**None**已选择，然后单击**下一步**。

1. 上**文档模板属性**页上，在**文件扩展名**框中，键入文件扩展名的文档，此应用程序创建，例如， *mfcrbnapp*. 单击 **“下一步”**。

1. 上**数据库支持**页上，请确保**None**已选择，然后单击**下一步**。

1. 上**用户界面功能**页上，请确保**使用功能区**处于选中状态。 单击 **“下一步”**。
