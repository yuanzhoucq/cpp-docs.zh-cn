...
您可以调用`CListCtrl`成员函数来排列列表项在控件中，对项进行排序和查找特定项。 有关详细信息，请参阅[使用 ListView 控件](/windows/desktop/Controls/using-list-view-controls)Windows SDK 中并[CListCtrl](../mfc/reference/clistctrl-class.md)成员[排列](../mfc/reference/clistctrl-class.md#arrange)， [SortItems](../mfc/reference/clistctrl-class.md#sortitems)，和[FindItem](../mfc/reference/clistctrl-class.md#finditem)。
