...
2.  [定义的成员变量](../mfc/activex-control-containers-connecting-an-activex-control-to-a-member-variable.md)（或其他形式的访问权限） 的类型相同，ActiveX 控件包装器类。  
  
3.  [ActiveX 控件编程](#_core_programming_the_activex_control)使用预定义的包装器类的成员函数。  
