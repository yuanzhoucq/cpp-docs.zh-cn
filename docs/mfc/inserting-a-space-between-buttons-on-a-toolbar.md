...
通常情况下，若要在按钮之间插入间隔，只需在工具栏中将它们彼此拖开即可。  若要移除间隔，请将它们往一起拖动。  
  
### 在后面没有间隔的按钮前插入间隔  
  
1.  向右或向下拖动按钮，直到与下一个按钮重叠大约一半。  
  
### 在后面有间隔的按钮前插入间隔并保持后面的间隔  
  
1.  拖动按钮，直到右边缘或下边缘刚好接触到下一个按钮或刚好与其重叠。  
  
### 在后面有间隔的按钮前插入间隔并消去后面的间隔  
