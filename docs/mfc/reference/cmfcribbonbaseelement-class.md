...
|名称|描述|  
|----------|-----------------|  
|[CMFCRibbonBaseElement::AddToKeyList](#addtokeylist)|将功能区元素快捷键提示添加到数组的键提示。|  
...
|[CMFCRibbonBaseElement::CanBeCompacted](#canbecompacted)|指示是否可以 compact 功能区元素的大小。|  
|[Cmfcribbonbaseelement:: Canbestretched](#canbestretched)|指示是否功能区元素的高度，可以提高垂直为功能区行的高度。|  
|[CMFCRibbonBaseElement::CanBeStretchedHorizontally](#canbestretchedhorizontally)|指示是否可以更改功能区元素的宽度。|  
|[Cmfcribbonbaseelement:: Cleanupsizes](#cleanupsizes)|清理功能区元素的维度设置。|  
|[Cmfcribbonbaseelement:: Closepopupmenu](#closepopupmenu)|关闭弹出菜单中的功能区元素。|  
|[CMFCRibbonBaseElement::CopyFrom](#copyfrom)|将复制的指定状态`CMFCRibbonBaseElement`与当前对象。|  
|[CMFCRibbonBaseElement::DestroyCtrl](#destroyctrl)|销毁功能区元素。|  
|[Cmfcribbonbaseelement:: Drawimage](#drawimage)|绘制功能区元素的图像。|  
|[CMFCRibbonBaseElement::Find](#find)|如果它指向当前对象，指定的指针返回到功能区元素。|  
|[CMFCRibbonBaseElement::FindByData](#findbydata)|检索指向功能区元素的指针，如果它包含指定的数据。|  
|[CMFCRibbonBaseElement::FindByID](#findbyid)|检索指向功能区元素的指针，如果该元素由指定的命令 id。|  
|[CMFCRibbonBaseElement::FindByOriginal](#findbyoriginal)|检索指向功能区元素的指针，如果其原始功能区元素匹配的指定功能区元素。|  
...
|[CMFCRibbonBaseElement::GetElementsByID](#getelementsbyid)|将当前的功能区元素添加到指定的数组，如果当前的功能区元素包含指定的命令 id。|  
|[CMFCRibbonBaseElement::GetHighlighted](#gethighlighted)|检索指向功能区元素的指针，如果它突出显示。|  
...
|[CMFCRibbonBaseElement::GetLocationInGroup](#getlocationingroup)|指示功能区组中的功能区元素的显示位置。|  
|[CMFCRibbonBaseElement::GetMenuKeys](#getmenukeys)|返回与按钮相关联的键提示。|  
...
|[CMFCRibbonBaseElement::GetPressed](#getpressed)|如果用户当前按下它，检索指向功能区元素的指针。|  
|[CMFCRibbonBaseElement::GetQuickAccessToolBarID](#getquickaccesstoolbarid)|当它位于快速访问工具栏时检索的功能区元素的命令 ID。|  
...
|[CMFCRibbonBaseElement::GetText](#gettext)|返回功能区元素与关联的文本。|  
|[Cmfcribbonbaseelement:: Gettooltiptext](#gettooltiptext)|返回功能区元素的工具提示文本。|  
|[CMFCRibbonBaseElement::GetTopLevelRibbonBar](#gettoplevelribbonbar)|检索的功能区元素的顶部级别的功能区栏。|  
...
|[Cmfcribbonbaseelement:: Haslargemode](#haslargemode)|指定功能区元素是否有大型模式。|  
|[Cmfcribbonbaseelement:: Hasmenu](#hasmenu)|指示功能区元素是否具有一个菜单。|  
|[CMFCRibbonBaseElement::HitTest](#hittest)|如果指定的点位于它，检索指向功能区元素的指针。|  
|[CMFCRibbonBaseElement::IsAlignByColumn](#isalignbycolumn)|表示功能区元素是否与其他功能区元素垂直对齐。|  
|[Cmfcribbonbaseelement:: Isalwayslargeimage](#isalwayslargeimage)|指示功能区元素映像大小是否始终大。|  
|[CMFCRibbonBaseElement::IsAutoRepeatMode](#isautorepeatmode)|指示功能区元素是否处于自动重复模式。|  
|[CMFCRibbonBaseElement::IsChecked](#ischecked)|指定是否检查功能区元素。|  
|[CMFCRibbonBaseElement::IsCompactMode](#iscompactmode)|指定功能区元素是否在压缩模式。|  
|[CMFCRibbonBaseElement::IsDefaultMenuLook](#isdefaultmenulook)||  
|[CMFCRibbonBaseElement::IsDisabled](#isdisabled)|指定是否禁用功能区元素。|  
|[CMFCRibbonBaseElement::IsDroppedDown](#isdroppeddown)|确定是否显示弹出菜单和拉下的功能区元素。|  
...
|[CMFCRibbonBaseElement::IsIntermediateMode](#isintermediatemode)|指示功能区元素的当前映像是否为中间的大小。|  
|[CMFCRibbonBaseElement::IsLargeMode](#islargemode)|指示是否当前的映像的功能区元素是大型调整大小。|  
|[CMFCRibbonBaseElement::IsMenuMode](#ismenumode)|指示功能区元素是否包含菜单中。|  
|[CMFCRibbonBaseElement::IsPressed](#ispressed)|指示用户是否已单击功能区元素。|  
|[CMFCRibbonBaseElement::IsQATMode](#isqatmode)|指示功能区元素是否包含快速访问工具栏中。|  
|[CMFCRibbonBaseElement::IsSeparator](#isseparator)|指示功能区元素是否显示分隔符。|  
|[CMFCRibbonBaseElement::IsShowGroupBorder](#isshowgroupborder)|指示功能区元素是否包含的组中，将显示常见边框。|  
|[CMFCRibbonBaseElement::IsShowTooltipOnBottom](#isshowtooltiponbottom)|指示是否将工具提示显示在功能区元素。|  
...
|[CMFCRibbonBaseElement::IsWholeRowHeight](#iswholerowheight)|指示功能区元素显示 heigth 是否与包含它的功能区面板的显示高度相同。|  
|[CMFCRibbonBaseElement::NotifyCommand](#notifycommand)|向功能区元素的父窗口发送命令通知。|  
|[CMFCRibbonBaseElement::NotifyHighlightListItem](#notifyhighlightlistitem)|用户突出显示在列表中找到的功能区元素时，请通知功能区栏的父窗口。|  
...
|[CMFCRibbonBaseElement::OnAutoRepeat](#onautorepeat)|更新到持续的用户输入的响应中的功能区元素。|  
|[Cmfcribbonbaseelement:: Oncalctextsize](#oncalctextsize)|计算的功能区元素的文本的大小。|  
|[CMFCRibbonBaseElement::OnChangeMenuHighlight](#onchangemenuhighlight)|位于菜单中的功能区元素的突出显示发生变化时，由框架调用。|  
|[Cmfcribbonbaseelement:: Ondraw](#ondraw)|由框架调用以绘制功能区元素。|  
|[CMFCRibbonBaseElement::OnDrawKeyTip](#ondrawkeytip)|由框架调用以绘制上方功能区元素的键提示。|  
|[Cmfcribbonbaseelement:: Ondrawmenuimage](#ondrawmenuimage)|绘制功能区元素的菜单图像时由框架调用。|  
|[CMFCRibbonBaseElement::OnDrawOnList](#ondrawonlist)|由框架调用以命令列表框中绘制功能区元素。|  
|[CMFCRibbonBaseElement::OnKey](#onkey)|当用户按下快捷键提示和功能区元素具有焦点时，由框架调用。|  
|[CMFCRibbonBaseElement::OnMenuKey](#onmenukey)||  
|[CMFCRibbonBaseElement::OnRTLChanged](#onrtlchanged)|布局更改方向时由框架调用。|  
...
|[CMFCRibbonBaseElement::Redraw](#redraw)|更新功能区元素的显示。|  
...
|[CMFCRibbonBaseElement::SetData](#setdata)|将功能区元素与关联的数据项。|  
...
|[CMFCRibbonBaseElement::SetKeys](#setkeys)|设置上方功能区元素的键提示。|  
...
|[CMFCRibbonBaseElement::StretchToWholeRow](#stretchtowholerow)|为指定的行高度的更改的功能区元素的显示高度。|  
|[CMFCRibbonBaseElement::UpdateTooltipInfo](#updatetooltipinfo)|通过使用功能区元素的命令资源来更新的工具提示文本。|  
  
### <a name="protected-methods"></a>受保护的方法  
  
|名称|描述|  
|----------|-----------------|  
|[CMFCRibbonBaseElement::OnProcessKey](#onprocesskey)|当用户按下的快捷键时由框架调用。|  
|[CMFCRibbonBaseElement::OnSetFocus](#onsetfocus)|在功能区元素获得或失去输入的焦点时，由框架调用。|  
  
## <a name="remarks"></a>备注  
 `CMFCRibbonBaseElement`类定义是包括命令 ID、 文本标签、 工具提示文本、 元素描述和状态 （这可以已设定焦点的、 突出显示、 按下、 禁用、 检查，或向下删除） 的所有功能区元素共有的属性。  
  
 通过定义功能区元素的图像大小`RibbonImageType`成员，可以是以下值之一：  
  
- `RibbonImageLarge`  
  
- `RibbonImageSmall`  
  
 根据其大小，功能区元素显示是小型或大型图像。  
  
## <a name="example"></a>示例  
 下面的示例演示如何使用各种方法`CMFCRibbonBaseElement`类。 该示例演示如何获取`CMFCRibbonBaseElement`对象`CMFCRibbonStatusBar`类，请设置功能区元素的说明、 设置的文本、 设置快捷键提示，并设置功能区元素的工具提示文本。 此代码片段属于 [Draw Client 示例](../../visual-cpp-samples.md)。  
...
### <a name="remarks"></a>备注  
 启用功能区键提示功能后，框架将显示功能区键提示，当用户按下 ALT 键或 F10 键。  
...
### <a name="return-value"></a>返回值  
 `TRUE` 如果功能区元素的大小可以 compact;否则为`FALSE`。  
  
### <a name="remarks"></a>备注  
 功能区元素的大小可以是 compact、 中间，或大型。  
  
##  <a name="canbestretched"></a>  Cmfcribbonbaseelement:: Canbestretched  
 指示是否功能区元素的高度，可以提高垂直为功能区行的高度。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法始终返回`TRUE`。 重写此方法，以指示功能区元素的高度是否可以垂直增加到功能区行的高度。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法始终返回`FALSE`。 重写此方法，以指示是否可以更改功能区元素的宽度。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法没有任何影响。 重写此方法在派生类重置功能区元素的维度设置。  
...
##  <a name="copyfrom"></a>  CMFCRibbonBaseElement::CopyFrom  
 将复制的指定状态[CMFCRibbonBaseElement](../../mfc/reference/cmfcribbonbaseelement-class.md)与当前对象。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法没有任何影响。 重写此方法在派生类中，若要销毁的功能区元素。  
...
### <a name="parameters"></a>参数  
 ...
 [in] `type`  
 图像类型枚举值。 请参阅可能的值列表的备注的部分。  
  
 [in] `rectImage`  
 映像矩形中。  
  
### <a name="remarks"></a>备注  
 默认情况下此方法没有任何影响。 重写此方法在派生类以绘制功能区元素的图像。  
...
### <a name="return-value"></a>返回值  
 指向功能区元素的指针如果`pElement`指向当前对象; 否则为`NULL`。  
  
### <a name="remarks"></a>备注  
  
##  <a name="findbydata"></a>  CMFCRibbonBaseElement::FindByData  
 检索指向功能区元素的指针，如果它包含指定的数据。  
...
### <a name="return-value"></a>返回值  
 指向功能区元素，如果它包含指定的数据; 的指针否则为`NULL`。  
  
### <a name="remarks"></a>备注  
  
##  <a name="findbyid"></a>  CMFCRibbonBaseElement::FindByID  
 检索指向功能区元素的指针，如果该元素由指定的命令 id。  
...
### <a name="return-value"></a>返回值  
 指向功能区元素，如果该元素由指定的命令 ID; 的指针否则为`NULL`。  
  
### <a name="remarks"></a>备注  
  
##  <a name="findbyoriginal"></a>  CMFCRibbonBaseElement::FindByOriginal  
 检索指向当前的功能区元素的指针，如果其原始功能区元素匹配的指定功能区元素。  
...
### <a name="return-value"></a>返回值  
 指向其原始功能区元素都与匹配的指定功能区元素; 如果功能区元素的指针否则为`NULL`。  
...
> [!NOTE]
>  压缩大小意味着功能区元素将被截断 （它将显示一个小的映像或不包含文本图像）。  
...
### <a name="return-value"></a>返回值  
 功能区元素说明。 描述将显示在状态栏中，或在工具提示，或菜单按钮下，如果功能区元素位于[CMFCRibbonMainPanel 类](../../mfc/reference/cmfcribbonmainpanel-class.md)。  
...
### <a name="return-value"></a>返回值  
 指向功能区元素，如果关闭; 删除其弹出菜单的指针否则为`NULL`。  
...
##  <a name="getelementsbyid"></a>  CMFCRibbonBaseElement::GetElementsByID  
 将当前的功能区元素添加到指定的数组，如果当前的功能区元素包含指定的命令 id。  
...
### <a name="parameters"></a>参数  
 ...
 [in] `bIsMenu`  
 `TRUE` 如果功能区元素显示弹出菜单;否则为`FALSE`。  
  
### <a name="return-value"></a>返回值  
 始终返回一个具有 0 值的矩形。  
  
### <a name="remarks"></a>备注  
 重写此方法在派生类以返回快捷键提示边界矩形中。  
...
|`RibbonElementFirstInGroup`|功能区组最左侧显示功能区元素。|  
|`RibbonElementLastInGroup`|功能区元素将显示在功能区组的右端。|  
|`RibbonElementMiddleInGroup`|任意一端的功能区组不显示功能区元素。|  
...
### <a name="return-value"></a>返回值  
 指向功能区元素，如果此方法成功，则父窗口的指针否则为`NULL`。  
...
### <a name="return-value"></a>返回值  
 指向功能区元素如果成功，则此方法的顶部级别的功能区栏的指针否则为`NULL`。  
...
### <a name="return-value"></a>返回值  
 `TRUE` 如果功能区元素有压缩模式。 否则为 `FALSE`。  
  
### <a name="remarks"></a>备注  
  
> [!NOTE]
>  在 compact 模式中，元素显示的小图像。  
...
### <a name="return-value"></a>返回值  
 `TRUE` 如果功能区元素有中间模式，`FALSE`否则为。 在中间的模式中，元素的图像的右侧显示的小图像和文本。  
...
### <a name="return-value"></a>返回值  
 `TRUE` 如果功能区元素有大型模式。 否则为 `FALSE`。  
  
### <a name="remarks"></a>备注  
 在大型模式中，元素可能需要父面板中最大的高度。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法始终返回`FALSE`。 重写此方法在派生的类，以指示功能区元素是否具有一个菜单。  
  
##  <a name="hittest"></a>  CMFCRibbonBaseElement::HitTest  
 如果指定的点位于它，检索指向功能区元素的指针。  
...
### <a name="return-value"></a>返回值  
 指向如果它存在，则功能区元素的指针否则为`FALSE`。  
  
### <a name="remarks"></a>备注  
 默认情况下此方法始终返回有效指针到功能区元素时存在。 重写此方法，以指示是否点驻留在功能区元素。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法始终返回`TRUE`。 重写此方法在派生的类，以指示是否与其他功能区元素的派生的功能区元素垂直对齐。  
...
### <a name="return-value"></a>返回值  
 `TRUE` 如果功能区元素映像大小始终较大;否则为`FALSE`。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法始终返回`FALSE`。 重写此方法，以指示功能区元素是否处于自动重复模式。  
  
 在自动重复模式，功能区元素响应以设定间隔，以毫秒为单位，对持续的用户输入。  
...
### <a name="return-value"></a>返回值  
 `TRUE` 如果功能区元素已删除，并且显示弹出菜单;否则为`FALSE`。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法始终返回`FALSE`。 重写此方法在派生的类，以指示是否在功能区库中包含的功能区元素。  
...
### <a name="return-value"></a>返回值  
 `TRUE` 如果功能区元素的图像是大型大小;否则为`FALSE`。  
...
### <a name="return-value"></a>返回值  
 `TRUE` 如果显示一个常见的边框; 组中包含的功能区元素否则为`FALSE`。  
...
### <a name="return-value"></a>返回值  
 `TRUE` 如果工具提示显示在功能区元素;`FALSE`如果指针旁显示工具提示。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法始终返回`TRUE`。 重写此方法，以指示是否可以使用键盘选择功能区元素。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法始终返回`FALSE`。 重写此方法，以指示功能区元素的显示高度是否与包含它的功能区面板的显示高度相同。  
...
### <a name="parameters"></a>参数  
 [in] `bWithDelay`  
 `TRUE` 若要向父窗口中; 消息队列中添加命令通知`FALSE`立即将消息发送到父窗口。  
...
##  <a name="notifyhighlightlistitem"></a>  CMFCRibbonBaseElement::NotifyHighlightListItem  
 用户突出显示在列表中找到的功能区元素时，请通知功能区栏的父窗口。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法将更新的功能区元素的工具提示。 重写此方法以更改其显示矩形后更新的功能区元素。  
  
##  <a name="onautorepeat"></a>  CMFCRibbonBaseElement::OnAutoRepeat  
 更新到持续的用户输入的响应中的功能区元素。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法始终返回`FALSE`。 重写此方法以处理持续的用户输入。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法没有任何影响。 重写此方法以更新位于菜单中更改突出显示时的功能区元素。  
...
### <a name="parameters"></a>参数  
 ...
 [in] `bIsMenu`  
 `TRUE` 如果快捷键提示适用于弹出菜单按钮;否则为`FALSE`。  
...
### <a name="remarks"></a>备注  
 默认情况下此方法没有任何影响。 重写此方法以在布局更改方向时，调整功能区元素。 默认布局方向是从左到右。  
  
##  <a name="onsetfocus"></a>  CMFCRibbonBaseElement::OnSetFocus  
 在功能区元素获得或失去输入的焦点时，由框架调用。  
...
### <a name="remarks"></a>备注  
 如果您的应用程序来处理功能区元素的焦点的变化，重写此方法在派生类。  
...
### <a name="parameters"></a>参数  
 [in] `bCompactMode`  
 `TRUE` 若要减少的功能区元素; 的显示大小`FALSE`增加的功能区元素的显示大小。  
...
### <a name="parameters"></a>参数  
 ...
 `TRUE` 若要设置功能区元素显示为弹出命令;否则为`FALSE`。  
...
### <a name="remarks"></a>备注  
 上的状态栏中，或在工具提示，或菜单按钮下，框架将显示新的描述。  
...
### <a name="remarks"></a>备注  
 若要设置上方功能区元素的键提示，追加到的快捷键提示字符后跟换行符转义序列`lpszText`。  
...
### <a name="return-value"></a>返回值  
 `TRUE` 如果设置的显示高度;否则为`FALSE`。  
  
### <a name="remarks"></a>备注  
 重写此方法可以为指定的行高度的更改的功能区元素的显示高度。  
  
##  <a name="updatetooltipinfo"></a>  CMFCRibbonBaseElement::UpdateTooltipInfo  
 通过使用功能区元素的命令资源来更新的工具提示文本。  
