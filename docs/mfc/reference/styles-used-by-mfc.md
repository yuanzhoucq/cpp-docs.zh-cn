...
ms.openlocfilehash: 8f305e5a347d551c83202985087d270f0c078c21
ms.contentlocale: zh-cn
ms.lasthandoff: 09/12/2017

---
# <a name="styles-used-by-mfc"></a>Styles Used by MFC  
...
### <a name="button-text-alignment-styles"></a>Button text alignment styles  
...
### <a name="other-button-options"></a>Other button options  
...
## <a name="frame-window-styles"></a>Frame-window styles  
...
### <a name="message-box-types"></a>Message-box types  
...
### <a name="message-box-modality"></a>Message-box modality  
...
### <a name="message-box-icons"></a>Message-box icons  
...
### <a name="message-box-default-buttons"></a>Message-box default buttons  
...
|`SS_ENDELLIPSIS`|or `SS_PATHELLIPSIS` Replaces part of the given string with ellipses, if necessary, so that the result fits in the specified rectangle. <br /><br />You can specify `SS_END_ELLIPSIS` to replace characters at the end of the string, or `SS_PATHELLIPSIS` to replace characters in the middle of the string. If the string contains backslash (\\) characters, `SS_PATHELLIPSIS` preserves as much of the text after the last backslash as possible.|  
