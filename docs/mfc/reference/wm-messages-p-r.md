...
ms.locfileid: "50636613"
---
# <a name="wm-messages-p---r"></a>WM_ 消息：P - R
...
|ON_WM_PAINTCLIPBOARD()|afx_msg void [OnPaintClipboard](../../mfc/reference/cwnd-class.md#onpaintclipboard)（CWnd *，句柄）;|
...
|ON_WM_POWERBROADCAST()|afx_msg UINT[方法](../../mfc/reference/cwnd-class.md#onpowerbroadcast)（UINT，UINT）;|
