...
|[CTreeCtrl::CreateEx](#createex)|创建与指定的 Windows 扩展样式的树控件并将其附加到`CTreeCtrl`对象。|  
|[CTreeCtrl::DeleteAllItems](#deleteallitems)|删除在树视图控件中的所有项。|  
|[CTreeCtrl::DeleteItem](#deleteitem)|删除在树视图控件中的新项。|  
|[CTreeCtrl::EditLabel](#editlabel)|通过指定的树视图项就地编辑。|  
...
|[CTreeCtrl::Expand](#expand)|展开，或折叠，指定的树视图项的子项。|  
|[CTreeCtrl::GetBkColor](#getbkcolor)|检索当前的背景颜色的控件。|  
|[CTreeCtrl::GetCheck](#getcheck)|检索树控件项的复选状态。|  
|[CTreeCtrl::GetChildItem](#getchilditem)|检索指定的树视图项的子级。|  
|[CTreeCtrl::GetCount](#getcount)|检索与树视图控件的树项的数目。|  
...
|[CTreeCtrl::GetInsertMarkColor](#getinsertmarkcolor)|检索用来绘制树视图插入标记的颜色。|  
|[CTreeCtrl::GetItem](#getitem)|检索指定的树视图项的属性。|  
|[CTreeCtrl::GetItemData](#getitemdata)|返回与项目关联的 32 位应用程序特定值。|  
|[CTreeCtrl::GetItemExpandedImageIndex](#getitemexpandedimageindex)|检索要显示当前的树视图控件中的指定的项处于展开状态时的图像的索引。|  
|[CTreeCtrl::GetItemHeight](#getitemheight)|检索树视图项的当前的高度。|  
|[CTreeCtrl::GetItemImage](#getitemimage)|检索与项目关联的映像。|  
|[CTreeCtrl::GetItemPartRect](#getitempartrect)|检索当前的树视图控件中的指定项的指定部分的绑定矩形。|  
...
|[CTreeCtrl::GetNextItem](#getnextitem)|检索与匹配的指定的关系的下一步树视图项。|  
...
|[CTreeCtrl::GetPrevSiblingItem](#getprevsiblingitem)|检索指定的树视图项的前一个同级。|  
|[CTreeCtrl::GetPrevVisibleItem](#getprevvisibleitem)|检索指定的树视图项的上一可见项。|  
|[CTreeCtrl::GetRootItem](#getrootitem)|检索指定的树视图项的根。|  
|[CTreeCtrl::GetScrollTime](#getscrolltime)|检索树视图控件的最大滚动时间。|  
|[CTreeCtrl::GetSelectedCount](#getselectedcount)|检索当前的树视图控件中的选定项的数目。|  
|[CTreeCtrl::GetSelectedItem](#getselecteditem)|检索当前所选的树视图项。|  
|[CTreeCtrl::GetTextColor](#gettextcolor)|检索控件的当前文本颜色。|  
|[CTreeCtrl::GetToolTips](#gettooltips)|检索子树视图控件使用的工具提示控件的句柄。|  
|[CTreeCtrl::GetVisibleCount](#getvisiblecount)|检索与树视图控件的可见的树项的数目。|  
|[CTreeCtrl::HitTest](#hittest)|返回与相关光标的当前位置`CTreeCtrl`对象。|  
|[CTreeCtrl::InsertItem](#insertitem)|在树视图控件中插入新项。|  
|[CTreeCtrl::ItemHasChildren](#itemhaschildren)|返回非零，如果指定的项具有子项。|  
|[CTreeCtrl::MapAccIdToItem](#mapaccidtoitem)|将指定的可访问性标识符映射到当前的树视图控件中的树视图项的句柄。|  
|[CTreeCtrl::MapItemToAccID](#mapitemtoaccid)|将指定的句柄映射到为可访问性标识符对于当前的树视图控件中的树视图项。|  
|[CTreeCtrl::Select](#select)|选择、 滚动到视图中，或重绘的指定的树视图项。|  
...
|[CTreeCtrl::SetInsertMark](#setinsertmark)|在树视图控件中设置插入标记。|  
|[CTreeCtrl::SetInsertMarkColor](#setinsertmarkcolor)|设置用于绘制的树视图插入标记的颜色。|  
|[CTreeCtrl::SetItem](#setitem)|设置为指定的树视图项的属性。|  
|[CTreeCtrl::SetItemData](#setitemdata)|设置与项目关联的 32 位应用程序特定值。|  
|[CTreeCtrl::SetItemExpandedImageIndex](#setitemexpandedimageindex)|设置要显示当前的树视图控件中的指定的项处于展开状态时的图像的索引。|  
|[CTreeCtrl::SetItemHeight](#setitemheight)|查看项设置树的高度。|  
...
|[CTreeCtrl::SetLineColor](#setlinecolor)|设置树视图控件的当前行颜色。|  
...
|[CTreeCtrl::ShowInfoTip](#showinfotip)|在当前的树视图控件中显示指定项信息提示。|  
|[CTreeCtrl::SortChildren](#sortchildren)|对给定的父项的子级进行排序。|  
|[CTreeCtrl::SortChildrenCB](#sortchildrencb)|对排序使用的应用程序定义的排序函数给定的父项的子级。|  
  
## <a name="remarks"></a>备注  
 "树视图控件"是一个磁盘显示的项，如文档中的标题中索引，或文件和目录的项的分层列表的窗口。 每个项包含一个标签和一个可选位图图像，且每个项可以有一个与之关联的子项列表。 通过单击项，用户可以展开和折叠关联的子项列表。  
  
 此控件 (因此`CTreeCtrl`类) 仅适用于 Windows 98 和 Windows NT 版本 4 下运行的程序和更高版本。  
...
- [树视图控件参考](http://msdn.microsoft.com/library/windows/desktop/bb759988)Windows SDK 中。  
...
##  <a name="create"></a>  CTreeCtrl::Create  
 如果你在对话框模板，指定的树控件，或如果你使用[CTreeView](../../mfc/reference/ctreeview-class.md)，在创建对话框或视图时，树控件自动创建。  
 ...
 *dwStyle*  
 指定树视图控件的样式。 应用窗口样式中, 所述[CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679)，和的任意组合[树视图控件样式](http://msdn.microsoft.com/library/windows/desktop/bb760013)Windows SDK 中所述。  
  
 *rect*  
 指定树视图控件的大小和位置。 它可以是[CRect](../../atl-mfc-shared/reference/crect-class.md)对象或[RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897)结构。  
  
 *pParentWnd*  
 通常指定树视图控件的父窗口`CDialog`。 不得为 NULL。  
...
### <a name="remarks"></a>备注  
 如果你想要用作子窗口的某些其他窗口中创建树控件，使用`Create`成员函数。 如果你创建树的控件使用`Create`，你必须将其传递 WS_VISIBLE，除了其他树视图样式。  
  
 构造`CTreeCtrl`中两个步骤。 第一次调用构造函数中，然后调用`Create`，它创建树视图控件，并将其附加到`CTreeCtrl`对象。  
...
##  <a name="createdragimage"></a>  CTreeCtrl::CreateDragImage  
 调用此函数可在树视图控件中创建一个拖动位图给定项，创建图像列表位图，并将位图添加到图像列表。  
...
### <a name="return-value"></a>返回值  
 指向拖动位图已添加到，如果成功，则图像列表否则为 NULL。  
  
### <a name="remarks"></a>备注  
 应用程序使用的图像列表函数时所拖动的项显示图像。  
...
### <a name="parameters"></a>参数  
 *hItem*  
 要删除的树项的句柄。 如果*hitem*具有 TVI_ROOT 值时，将从树视图控件中删除所有项。  
...
### <a name="return-value"></a>返回值  
 如果成功，指向的指针`CEdit`用于编辑的项文本的对象; 否则为 NULL。  
  
### <a name="remarks"></a>备注  
 编辑是通过将项的文本替换为包含文本的单行编辑控件实现的。  
  
### <a name="example"></a>示例  
 [!code-cpp[NVC_MFC_CTreeCtrl#5](../../mfc/reference/codesnippet/cpp/ctreectrl-class_5.cpp)]  
  
##  <a name="endeditlabelnow"></a>  CTreeCtrl::EndEditLabelNow  
 最后，在当前的树视图控件中的树视图项的标签上的编辑操作。  
...
|参数|描述|  
|---------------|-----------------|  
|[in]*fCancelWithoutSave*|若要结束编辑操作或 FALSE 以结束该操作之前将更改保存到的树视图项之前放弃对的树视图项更改，则为 TRUE。|  
  
### <a name="return-value"></a>返回值  
 如果此方法成功，则为 TRUE否则为 FALSE。  
  
### <a name="remarks"></a>备注  
 此方法可发送[TVM_ENDEDITLABELNOW](http://msdn.microsoft.com/library/windows/desktop/bb773564)消息，Windows SDK 中介绍。  
...
### <a name="return-value"></a>返回值  
 如果系统滚动以确保指定的项是可见的树视图控件中的项，则返回 TRUE。 否则，返回值为 FALSE。  
  
### <a name="remarks"></a>备注  
 如有必要，该函数展开父项或滚动树视图控件，以使项可见。  
  
### <a name="example"></a>示例  
 [!code-cpp[NVC_MFC_CTreeCtrl#6](../../mfc/reference/codesnippet/cpp/ctreectrl-class_6.cpp)]  
  
##  <a name="expand"></a>  CTreeCtrl::Expand  
 如果任何，与给定的父项关联，请调用此函数可展开或折叠子项目的列表。  
 ...
 *nCode*  
 一个标志，指示要执行操作的类型。 此标志可以具有以下值之一：  
  
- TVE_COLLAPSE 折叠列表。  
  
- TVE_COLLAPSERESET 折叠列表，并删除子项。 TVIS_EXPANDEDONCE 状态标志被重置。 此标志必须与 TVE_COLLAPSE 标志一起使用。  
  
- TVE_EXPAND 会展开列表。  
  
- 如果它当前已展开，或如果它当前处于折叠状态中展开，则 TVE_TOGGLE 折叠列表。  
...
##  <a name="getbkcolor"></a>  CTreeCtrl::GetBkColor  
 此成员函数实现的 Win32 消息行为[TVM_GETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773570)，如 Windows SDK 中所述。  
...
### <a name="return-value"></a>返回值  
 一个表示控件的当前窗口背景色的 COLORREF 值。 此值为-1，如果控件正在使用的系统窗口颜色。 在这种情况下，你可以使用`::GetSysColor(COLOR_WINDOW)`若要获取的控件使用的当前系统颜色。  
...
### <a name="return-value"></a>返回值  
 指向用于编辑的项文本，如果成功，则编辑控件的指针否则为 NULL。  
...
### <a name="remarks"></a>备注  
 此方法可发送[TVM_GETEXTENDEDSTYLE](http://msdn.microsoft.com/library/windows/desktop/bb773580)消息，Windows SDK 中介绍。  
  
##  <a name="getfirstvisibleitem"></a>  CTreeCtrl::GetFirstVisibleItem  
 调用此函数可检索的树视图控件的第一个可见项。  
...
##  <a name="getimagelist"></a>  CTreeCtrl::GetImageList  
 调用此函数可检索的正常的句柄或树视图控件与关联的状态图像列表。  
...
### <a name="parameters"></a>参数  
 *nImageList*  
 要检索的映像列表的类型。 图像列表可以是以下值之一：  
  
- TVSIL_NORMAL 检索正常的图像列表，其中包含为树视图项的选定和未选定的映像。  
  
- TVSIL_STATE 检索状态图像列表，其中包含用于在用户定义的状态中的树视图项的映像。  
  
### <a name="return-value"></a>返回值  
 如果成功，则控件的图像列表的指针否则为 NULL。  
  
### <a name="remarks"></a>备注  
 在树视图控件中的每个项可以有与之关联的位图图像的对。 当选定了项，并显示其他时未选择项目时，会显示一个图像。 例如，某一项可能显示选中时打开的文件夹和关闭的文件夹，如果未选择。  
...
##  <a name="getindent"></a>  CTreeCtrl::GetIndent  
 调用此函数可检索量，以像素为单位，项将相对于其父项缩进该子级。  
...
##  <a name="getinsertmarkcolor"></a>  CTreeCtrl::GetInsertMarkColor  
 此成员函数实现的 Win32 消息行为[TVM_GETINSERTMARKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773590)，如 Windows SDK 中所述。  
...
### <a name="parameters"></a>参数  
 *pItem*  
 指向的指针[TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456)结构，如 Windows SDK 中所述。  
...
##  <a name="getitemexpandedimageindex"></a>  CTreeCtrl::GetItemExpandedImageIndex  
 检索要显示当前的树视图控件中的指定的项处于展开状态时的图像的索引。  
...
### <a name="remarks"></a>备注  
 此方法可发送[TVM_GETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773596)消息，Windows SDK 中介绍。 消息返回[TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459)结构描述的树视图控件项目，然后此方法检索`iExpandedImage`从该结构的成员。  
  
##  <a name="getitemheight"></a>  CTreeCtrl::GetItemHeight  
 此成员函数实现的 Win32 消息行为[TVM_GETITEMHEIGHT](http://msdn.microsoft.com/library/windows/desktop/bb773599)，如 Windows SDK 中所述。  
 ...
 *nSelectedImage*  
 一个整数，接收的项的树视图控件的图像列表中的所选映像的索引。  
  
### <a name="return-value"></a>返回值  
 如果成功，则不为 0；否则为 0。  
  
### <a name="remarks"></a>备注  
 在左侧的项的标签上显示图像。 当选定了项，并显示其他时未选择项目时，会显示一个图像。 例如，某一项可能显示选中时打开的文件夹和关闭的文件夹，如果未选择。  
  
 调用此函数可检索的项的图像和树视图控件的图像列表中其所选的映像的索引。  
  
### <a name="example"></a>示例  
 [!code-cpp[NVC_MFC_CTreeCtrl#16](../../mfc/reference/codesnippet/cpp/ctreectrl-class_16.cpp)]  
  
##  <a name="getitempartrect"></a>  CTreeCtrl::GetItemPartRect  
 检索当前的树视图控件中的指定项的指定部分的绑定矩形。  
...
|[out]*lpRect*|指向[RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897)结构。 如果此方法成功，结构接收为由指定的部件的矩形坐标*hItem*和*nPart*。|  
  
### <a name="return-value"></a>返回值  
 如果此方法成功，则为 TRUE否则为 FALSE。  
  
### <a name="remarks"></a>备注  
 每个树控件项受图形矩形。 单击该矩形中的点后，每当项则称其为*命中*。 此方法返回的最大矩形，这样，单击在矩形中的点后，由标识的项*hItem*命中参数。  
  
 此方法可发送的 TVM_GETITEMPARTRECT 消息，这 Windows SDK 中所述。 有关详细信息，请参阅[TreeView_GetItemPartRect](http://msdn.microsoft.com/library/windows/desktop/bb773847)宏。  
  
### <a name="example"></a>示例  
 下面的代码示例定义一个变量， `m_treeCtrl`，即用于访问当前的树视图控件。 代码示例还定义一个无符号的整数和若干 HTREEITEM 变量。 在下一步的示例中使用这些变量。  
  
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#1](../../mfc/reference/codesnippet/cpp/ctreectrl-class_17.h)]  
  
### <a name="example"></a>示例  
 下面的代码示例使用的可访问性标识符和[CTreeCtrl::MapAccIdToItem](#mapaccidtoitem)方法来检索到的根树视图项的句柄。 然后，该示例使用句柄和[CTreeCtrl::GetItemPartRect](#getitempartrect)方法，以便绘制该项周围的 3D 矩形。 前面部分的代码示例中，而不会显示，我们将创建包含美国根国家/地区节点、 宾夕法尼亚和华盛顿州的状态的子节点和在这些状态中的城市的树项树视图。 我们使用[CTreeCtrl::MapItemToAccID](#mapitemtoaccid)方法将根树视图项关联的辅助功能标识符。  
 ...
 *lpRect*  
 指向[RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897)结构，它接收的边框。 坐标为相对于树视图控件的左上角。  
  
 *bTextOnly*  
 此参数不为零，如果边界矩形将包括仅项的文本。 否则，它在树视图控件中包括项占用的整个行。  
  
### <a name="return-value"></a>返回值  
 如果边界矩形中包含与该项是可见，则为非 0 *lpRect*。 否则为 0 而*lpRect*未初始化。  
 ...
 *nStateMask*  
 掩码，指示要检索的一个或多个状态。 有关详细信息的可能值*nStateMask*，请参阅的讨论`state`和`stateMask`的成员[TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456) Windows SDK 中的结构。  
  
### <a name="return-value"></a>返回值  
 保存 nStateMask 指定的值的按位或 UINT。 有关可能的值的信息，请参阅[CTreeCtrl::GetItem](#getitem)。 若要查找特定状态的值，请执行状态的值和返回值的按位与运算，如下面的示例中所示。  
...
### <a name="remarks"></a>备注  
 此方法可发送[TVM_GETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773596)消息，Windows SDK 中介绍。 消息返回[TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459)描述的树视图控件项目，因此该方法的结构检索`uStateEx`从该结构的成员。  
...
### <a name="return-value"></a>返回值  
 如果成功，则此方法的最后一未扩展的节点项窗口的句柄否则，为 NULL。  
  
### <a name="remarks"></a>备注  
 此方法可发送[TVM_GETNEXTITEM](http://msdn.microsoft.com/library/windows/desktop/bb773622)消息，Windows SDK 中介绍。 有关详细信息，请参阅中的 TVGN_LASTVISIBLE 标志*标志*该消息的参数。  
  
### <a name="example"></a>示例  
 下面的代码示例定义一个变量， `m_treeCtrl`，即用于访问当前的树视图控件。 代码示例还定义一个无符号的整数和若干 HTREEITEM 变量。 在下一个示例使用一个或多个这些变量。  
  
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#1](../../mfc/reference/codesnippet/cpp/ctreectrl-class_17.h)]  
  
### <a name="example"></a>示例  
 下面的代码示例检索到最后一个未扩展的树视图节点项的句柄，然后绘制该项周围的 3D 矩形。 前面部分的代码示例中，而不会显示，我们将创建包含美国根国家/地区节点、 宾夕法尼亚和华盛顿州的状态的子节点和在这些状态中的城市的树项树视图。  
...
##  <a name="getlinecolor"></a>  CTreeCtrl::GetLineColor  
 此成员函数实现的 win32 消息行为[TVM_GETLINECOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773619)，如 Windows SDK 中所述。  
...
##  <a name="getnextitem"></a>  CTreeCtrl::GetNextItem  
 调用此函数可检索的树视图项，具有指定的关系，由*nCode*参数到*hItem*。  
 ...
 *nCode*  
 一个标志，指示与相关的一种*hItem*。 此标志可以是以下值之一：  
  
- TVGN_CARET 检索当前所选的项。  
  
- TVGN_CHILD 检索由指定的项的第一子项*hItem*参数。  
  
- TVGN_DROPHILITE 检索拖放操作的目标的项。  
  
- TVGN_FIRSTVISIBLE 检索第一个可见项。  
  
- TVGN_LASTVISIBLE 检索最后展开树中的项。 这并不检索树视图窗口中可见的最后一项。  
...
### <a name="return-value"></a>返回值  
 如果成功，则下一步项的句柄否则为 NULL。  
  
### <a name="remarks"></a>备注  
 如果要检索的项是树的根节点，此函数将返回 NULL。 例如，如果你使用在树视图的根节点的第一级子 TVGN_PARENT 标志中使用此消息，消息将返回 NULL。  
  
### <a name="example"></a>示例  
 有关使用示例`GetNextItem`在循环中，请参阅[CTreeCtrl::DeleteItem](#deleteitem)。  
...
### <a name="remarks"></a>备注  
 此成员函数实现的 win32 消息行为[TVM_GETSCROLLTIME](http://msdn.microsoft.com/library/windows/desktop/bb773625)，如 Windows SDK 中所述。  
...
### <a name="remarks"></a>备注  
 此方法可发送[TVM_GETSELECTEDCOUNT](http://msdn.microsoft.com/library/windows/desktop/bb773629)消息，Windows SDK 中介绍。  
  
##  <a name="getselecteditem"></a>  CTreeCtrl::GetSelectedItem  
 调用此函数可检索树视图控件的当前选定的项。  
...
##  <a name="gettextcolor"></a>  CTreeCtrl::GetTextColor  
 此成员函数实现的 Win32 消息行为[TVM_GETTEXTCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773633)，如 Windows SDK 中所述。  
...
##  <a name="gettooltips"></a>  CTreeCtrl::GetToolTips  
 此成员函数实现的 Win32 消息行为[TVM_GETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb773729)，如 Windows SDK 中所述。  
...
### <a name="return-value"></a>返回值  
 指向的指针[CToolTipCtrl](../../mfc/reference/ctooltipctrl-class.md)树控件要使用的对象。 如果[创建](#create)成员函数使用的样式 TVS_NOTOOLTIPS、 使用任何工具提示，并返回 NULL。  
  
### <a name="remarks"></a>备注  
 MFC 实现`GetToolTips`返回`CToolTipCtrl`对象，使用树控件，而不是工具提示控件的句柄。  
 ...
 *pFlags*  
 指向一个整数，它接收的命中测试结果的相关信息。 它可以是一个或多个值下列出`flags`备注部分中的成员。  
  
 *pHitTestInfo*  
 地址[TVHITTESTINFO](http://msdn.microsoft.com/library/windows/desktop/bb773448)结构，它包含要进行命中测试和该位置接收的命中测试结果的相关信息。  
  
### <a name="return-value"></a>返回值  
 如果任何项不占用点所占据的指定的点或为 NULL 的树视图项的句柄。  
  
### <a name="remarks"></a>备注  
 当调用此函数时， *pt*参数指定要测试的点的坐标。 如果任何项不占用点，则该函数返回处的指定的点或为 NULL 的项的句柄。 此外， *pFlags*参数包含一个值，该值指示指定的点的位置。 可能的值有：  
...
|TVHT_ONITEMBUTTON|与项目关联的按钮。|  
|TVHT_ONITEMICON|在与项目相关联的位图。|  
...
### <a name="parameters"></a>参数  
 *lpInsertStruct*  
 指向的指针`TVINSERTSTRUCT`，它指定要插入的树视图项的属性。  
 ...
 *nSelectedImage*  
 索引的项的树视图控件的图像列表中选择的映像。  
  
 *nState*  
 指定项的状态的值。 请参阅树视图控件项状态的相应状态的列表的 Windows SDK 中。  
...
### <a name="remarks"></a>备注  
 该示例演示在其中你可能想要插入的树控件项时使用该函数的每个版本的情况。  
...
### <a name="return-value"></a>返回值  
 如果树项指定非零*hItem*有个子项; 如果它不为 0。  
  
### <a name="remarks"></a>备注  
 因此，你可以然后使用如果[CTreeCtrl::GetChildItem](#getchilditem)检索这些子项。  
  
### <a name="example"></a>示例  
  请参阅示例[CTreeCtrl::GetSelectedItem](#getselecteditem)。  
  
##  <a name="mapaccidtoitem"></a>  CTreeCtrl::MapAccIdToItem  
 将指定的可访问性标识符映射到当前的树视图控件中的树视图项的句柄。  
...
|参数|描述|  
|---------------|-----------------|  
|[in]*uAccId*|中的树视图项的某个元素可访问性标识符。|  
  
### <a name="return-value"></a>返回值  
 树视图项的句柄 ( `HTREEITEM`) 相对应的*uAccId*参数。 有关详细信息，请参阅*hItem*的成员[TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459)结构。  
  
### <a name="remarks"></a>备注  
 辅助功能是，用于帮助残障人士使用的应用程序使用的计算机。 可访问性标识符由`IAccessible`接口才能唯一指定在窗口中的元素。 有关辅助功能标识符的详细信息，搜索在"有关活动可访问性支持"主题[Microsoft Developer Network](http://go.microsoft.com/fwlink/p/?linkid=56322)。  
  
 此方法可发送[TVM_MAPACCIDTOHTREEITEM](http://msdn.microsoft.com/library/windows/desktop/bb773734)消息，Windows SDK 中介绍。  
...
### <a name="example"></a>示例  
 下面的代码示例使用的可访问性标识符和[CTreeCtrl::MapAccIdToItem](#mapaccidtoitem)方法来检索到的根树视图项的句柄。 该示例使用句柄和[CTreeCtrl::GetItemPartRect](#getitempartrect)方法，以便绘制该项周围的 3D 矩形。 前面部分的代码示例中，而不会显示，我们将创建包含美国根国家/地区节点、 宾夕法尼亚和华盛顿州的状态的子节点和在这些状态中的城市的树项树视图。 我们使用[CTreeCtrl::MapItemToAccID](#mapitemtoaccid)方法将根树视图项关联的辅助功能标识符。  
...
### <a name="remarks"></a>备注  
 ...
 此方法可发送[TVM_MAPHTREEITEMTOACCID](http://msdn.microsoft.com/library/windows/desktop/bb773735)消息，Windows SDK 中介绍。  
...
### <a name="example"></a>示例  
 下面的代码示例获取树视图控件项的标识号。 前面部分的代码示例中，而不会显示，我们将创建包含美国根国家/地区节点、 宾夕法尼亚和华盛顿州的状态的子节点和在这些状态中的城市的树项树视图。 此代码示例获取根国家/地区节点的唯一标识号。  
  
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#2](../../mfc/reference/codesnippet/cpp/ctreectrl-class_31.cpp)]  
  
##  <a name="select"></a>  CTreeCtrl::Select  
 调用此函数可选择的给定的树视图项，将项滚动到视图中，或在用于指示拖放操作的目标的样式重绘项。  
...
- TVGN_CARET 将所选内容设置为给定的项目。  
  
- TVGN_DROPHILITE 重绘样式中的给定的项，用于指示拖放操作的目标。  
  
- TVGN_FIRSTVISIBLE 滚动树视图垂直，以便给定的项是第一个可见项。  
  
### <a name="return-value"></a>返回值  
 如果成功，则不为 0；否则为 0。  
  
### <a name="remarks"></a>备注  
 如果*nCode*包含值 TVGN_CARET，父窗口接收 TVN_SELCHANGING 和 TVN_SELCHANGED 通知消息。 此外，如果指定的项目，则折叠的父项的子级，父级的子项列表展开以显示指定的项。 在这种情况下，父窗口接收 TVN_ITEMEXPANDING 和 TVN_ITEMEXPANDED 通知消息。  
  
### <a name="example"></a>示例  
  请参阅示例[CTreeCtrl::HitTest](#hittest)。  
  
##  <a name="selectdroptarget"></a>  CTreeCtrl::SelectDropTarget  
 调用此函数可用于指示拖放操作的目标的样式在重绘项。  
...
### <a name="remarks"></a>备注  
 自动滚动参数用于滚动到视图中当前不可见的项。 树视图控件必须具有扩展样式中, 所述 TVS_EX_AUTOHSCROLL[树视图控件扩展样式](http://msdn.microsoft.com/library/windows/desktop/bb759981)。  
  
 此方法可发送[TVM_SETAUTOSCROLLINFO](http://msdn.microsoft.com/library/windows/desktop/bb773738)消息，Windows SDK 中介绍。  
...
### <a name="example"></a>示例  
 下面的代码示例设置当前的树视图控件的滚动行为。 前面部分的代码示例中，而不会显示，我们将创建包含美国根国家/地区节点、 宾夕法尼亚和华盛顿州的状态的子节点和在这些状态中的城市的树项树视图。 我们特意进行树视图控件窄，因此它必须自动滚动以显示具有焦点的树项。 代码示例设置要自动滚动每秒视图中的树项之前每隔 5 秒 30 个像素的树视图控件。  
...
##  <a name="setbkcolor"></a>  CTreeCtrl::SetBkColor  
 此成员函数实现的 Win32 消息行为[TVM_SETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773741)，如 Windows SDK 中所述。  
...
### <a name="parameters"></a>参数  
 *clr*  
 包含新的背景色的 COLORREF 值。 如果此值为-1，控件将恢复为背景色使用的系统颜色。  
 ...
 *查看*  
 指示是否要选中或取消选中的树控件项目。 默认情况下，`SetCheck`要检查的项设置。  
  
### <a name="return-value"></a>返回值  
 如果成功，则不为 0；否则为 0。  
  
### <a name="remarks"></a>备注  
 当检查的树控件项目 (*查看*设置为 TRUE)，则项目会显示与相邻的复选标记。  
...
|参数|描述|  
|---------------|-----------------|  
|[in]*dwExMask*|指定当前的树视图控件中的样式会影响此方法的位掩码。 如果此参数为零，它将忽略和的值*dwExStyles*参数分配给树视图控件。<br /><br /> 指定零个或样式中所述的按位组合 (OR)[树视图控件扩展样式](http://msdn.microsoft.com/library/windows/desktop/bb759981)。|  
|[in]*dwExStyles*|指定当前的树视图中的样式来控制对设置或清除的位掩码。<br /><br /> 若要设置样式的组合，指定样式中所述的按位组合 (OR)[树视图控件扩展样式](http://msdn.microsoft.com/library/windows/desktop/bb759981)。 若要清除一组的样式，指定零。|  
  
### <a name="return-value"></a>返回值  
 一个值，包含以前扩展控件样式。  
  
### <a name="remarks"></a>备注  
 此方法清除中指定的样式*dwExMask*参数，然后设置中指定的样式*dwExStyles*参数。 仅与中的位相对应的扩展的样式*dwExMask*更改。  
  
 此方法可发送[TVM_SETEXTENDEDSTYLE](http://msdn.microsoft.com/library/windows/desktop/bb773744)消息，Windows SDK 中介绍。  
...
### <a name="example"></a>示例  
 下面的代码示例将 TVS_EX_AUTOHSCROLL 扩展样式添加到当前的树视图控件。 前面部分的代码示例中，而不会显示，我们将创建包含美国根国家/地区节点、 宾夕法尼亚和华盛顿州的状态的子节点和在这些状态中的城市的树项树视图。 我们特意进行树视图控件窄，因此它必须自动滚动以显示具有焦点的树项。  
...
- TVSIL_NORMAL 设置正常的图像列表，其中包含为树视图项的选定和未选定的映像。 有关覆盖图像，必须使用此状态。  
  
- TVSIL_STATE 设置状态图像列表，其中包含用于在用户定义的状态中的树视图项的映像。  
  
### <a name="return-value"></a>返回值  
 指向上一个图像列表中，如果任何;否则为 NULL。  
...
##  <a name="setinsertmark"></a>  CTreeCtrl::SetInsertMark  
 此成员函数实现的 Win32 消息行为[TVM_SETINSERTMARK](http://msdn.microsoft.com/library/windows/desktop/bb773753)，如 Windows SDK 中所述。  
...
### <a name="parameters"></a>参数  
 *hItem*  
 指定在哪一项插入标记将放置的 HTREEITEM。 如果此参数为 NULL，则会删除插入标记。  
  
 *fAfter*  
 BOOL 值，该值指定是否插入标记位于之前或之后指定的项。 如果此参数不为零，则将项后放置插入标记。 如果此参数为零，则将该项的前面放置插入标记。  
...
##  <a name="setinsertmarkcolor"></a>  CTreeCtrl::SetInsertMarkColor  
 此成员函数实现的 Win32 消息行为[TVM_SETINSERTMARKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773755)，如 Windows SDK 中所述。  
...
### <a name="parameters"></a>参数  
 *clrNew*  
 包含新的插入标记颜色的 COLORREF 值。  
  
### <a name="return-value"></a>返回值  
 包含以前的插入标记颜色的 COLORREF 值。  
...
### <a name="parameters"></a>参数  
 *pItem*  
 指向的指针[TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456)结构，其中包含新的项属性，如 Windows SDK 中所述。  
  
 *hItem*  
 要设置其属性的项的句柄。 请参阅`hItem`的成员`TVITEM`Windows SDK 中的结构。  
  
 *nMask*  
 指定要设置的属性的整数。 请参阅`mask`的成员`TVITEM`结构。  
 ...
 *nSelectedImage*  
 索引的项的树视图控件的图像列表中选择的映像。 请参阅`iSelectedImage`的成员`TVITEM`结构。  
  
 *nState*  
 指定项的状态的值。 请参阅`State`的成员`TVITEM`结构。  
  
 *nStateMask*  
 指定要设置的状态。 请参阅`stateMask`的成员`TVITEM`结构。  
...
### <a name="remarks"></a>备注  
 在`TVITEM`结构，`hItem`成员标识该项目，与`mask`成员指定要设置的属性。  
  
 如果`mask`成员或*nMask*参数指定 TVIF_TEXT 值`pszText`成员或*lpszItem*是以 null 结尾的字符串的地址和`cchTextMax`成员将被忽略。 如果`mask`(或*nMask*) 指定 TVIF_STATE 值，`stateMask`成员或*nStateMask*参数指定的项状态更改和`state`成员或*nState*参数包含这些状态的值。  
  
### <a name="example"></a>示例  
 [!code-cpp[NVC_MFC_CTreeCtrl#32](../../mfc/reference/codesnippet/cpp/ctreectrl-class_38.cpp)]  
  
##  <a name="setitemdata"></a>  CTreeCtrl::SetItemData  
 调用此函数可设置与指定的项关联的 32 位应用程序特定值。  
...
##  <a name="setitemexpandedimageindex"></a>  CTreeCtrl::SetItemExpandedImageIndex  
 设置要显示当前的树视图控件中的指定的项处于展开状态时的图像的索引。  
...
### <a name="remarks"></a>备注  
 此方法可发送[TVM_SETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773758)消息，Windows SDK 中介绍。 此方法将分配*iExpandedImage*参数`iExpandedImage`的成员[TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459)结构，然后在消息结构的使用。  
...
### <a name="example"></a>示例  
 下面的代码示例是一个普通的测试，以确定是否[CTreeCtrl::GetItemExpandedImageIndex](#getitemexpandedimageindex)方法返回所设置的值[CTreeCtrl::SetItemExpandedImageIndex](#setitemexpandedimageindex)方法。 前面部分的代码示例中，而不会显示，我们将创建包含美国根国家/地区节点、 宾夕法尼亚和华盛顿州的状态的子节点和在这些状态中的城市的树项树视图。  
...
##  <a name="setitemheight"></a>  CTreeCtrl::SetItemHeight  
 此成员函数实现的 Win32 消息行为[TVM_SETITEMHEIGHT](http://msdn.microsoft.com/library/windows/desktop/bb773761)，如 Windows SDK 中所述。  
...
### <a name="parameters"></a>参数  
 *cyHeight*  
 在树视图中，以像素为单位指定每个项的新高度。 如果此参数为图像高度小于，则它将设置为图像高度。 如果此参数不为偶数，它将舍入到最接近偶数值。 如果此参数为-1，控件将恢复为使用其默认项高度。  
...
### <a name="remarks"></a>备注  
 在树视图控件中的每个项可以有与之关联的位图图像的对。 在左侧的项的标签上显示图像。 当选定了项，并显示其他时未选择项目时，会显示一个图像。 例如，某一项可能显示选中时打开的文件夹和关闭的文件夹，如果未选择。  
  
 调用此函数可设置的项的图像和树视图控件的图像列表中其所选的映像的索引。  
...
### <a name="remarks"></a>备注  
 此方法可发送[TVM_SETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773758)消息，Windows SDK 中介绍。 此方法将分配*uStateEx*参数`uStateEx`的成员[TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459)结构，然后在消息结构的使用。  
...
### <a name="example"></a>示例  
 下面的代码示例将树视图项设置为禁用状态。 前面部分的代码示例中，而不会显示，我们将创建包含美国根国家/地区节点、 宾夕法尼亚和华盛顿州的状态的子节点和在这些状态中的城市的树项树视图。 此代码示例将宾夕法尼亚节点设置为禁用状态。  
...
### <a name="remarks"></a>备注  
 此成员函数实现的 win32 消息行为[TVM_SETLINECOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773764)，如 Windows SDK 中所述。  
...
### <a name="parameters"></a>参数  
 *uScrollTime*  
 新的最大滚动时间，以毫秒为单位。 如果此值是小于 100，则它将舍入最多 100。  
  
### <a name="return-value"></a>返回值  
 上一个最大滚动时间，以毫秒为单位。  
  
### <a name="remarks"></a>备注  
 此成员函数实现的 win32 消息行为[TVM_SETSCROLLTIME](http://msdn.microsoft.com/library/windows/desktop/bb773767)，如 Windows SDK 中所述。  
  
##  <a name="settextcolor"></a>  CTreeCtrl::SetTextColor  
 此成员函数实现的 Win32 消息行为[TVM_SETTEXTCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773769)，如 Windows SDK 中所述。  
...
### <a name="parameters"></a>参数  
 *clr*  
 包含新的文本颜色的 COLORREF 值。 如果此参数为-1，控件将恢复为使用的文本颜色的系统颜色。  
  
### <a name="return-value"></a>返回值  
 一个 COLORREF 值，表示以前的文本颜色。 此值为-1，如果控件已使用的系统颜色的文本颜色。  
...
##  <a name="settooltips"></a>  CTreeCtrl::SetToolTips  
 此成员函数实现的 Win32 消息行为[TVM_SETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb773772)，如 Windows SDK 中所述。  
...
### <a name="parameters"></a>参数  
 *pWndTip*  
 指向的指针[CToolTipCtrl](../../mfc/reference/ctooltipctrl-class.md)树控件将使用的对象。  
  
### <a name="return-value"></a>返回值  
 指向的指针[CToolTipCtrl](../../mfc/reference/ctooltipctrl-class.md)对象，其中包含以前使用的控件或为 NULL 的如果没有工具提示先前使用的工具提示。  
  
### <a name="remarks"></a>备注  
 若要使用工具提示，指示 TVS_NOTOOLTIPS 样式创建时`CTreeCtrl`对象。  
...
### <a name="remarks"></a>备注  
 有关工具提示和 infotips 之间的差异的详细信息，搜索在"工具提示和 Infotips"主题[Microsoft Developer Network](http://go.microsoft.com/fwlink/p/?linkid=56322)。  
  
 此方法可发送[TVM_SHOWINFOTIP](http://msdn.microsoft.com/library/windows/desktop/bb773779)消息，Windows SDK 中介绍。  
...
### <a name="parameters"></a>参数  
 *hItem*  
 子项是要排序的父项的句柄。 如果*hItem*为 NULL，排序将继续从树的根。  
  
### <a name="return-value"></a>返回值  
 如果成功，则不为 0；否则为 0。  
  
### <a name="remarks"></a>备注  
 `SortChildren` 将不 recurse 通过在树中。仅的直属子级的*hItem*进行排序。  
...
##  <a name="sortchildrencb"></a>  CTreeCtrl::SortChildrenCB  
 调用此函数可使用一个应用程序定义的回调函数，比较的项的树视图项进行排序。  
...
### <a name="remarks"></a>备注  
 结构的比较函数， `lpfnCompare`，必须返回一个负数的值的第一项应位于第二个之前，如果一个正值如果第一项应遵循第二个，或如果两个项是等效项。  
  
 *LParam1*和*lParam2*参数都对应于`lParam`的成员[TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456)结构的两个项进行比较。 *LParamSort*参数对应于`lParam`的成员`TV_SORTCB`结构。  
