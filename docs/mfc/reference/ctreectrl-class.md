...
### <a name="parameters"></a>参数  
 `dwStyle`  
 指定树视图控件的样式。 应用窗口样式中, 所述[CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679)，和的任意组合[树视图控件样式](http://msdn.microsoft.com/library/windows/desktop/bb760013)中所述[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
##  <a name="getbkcolor"></a>CTreeCtrl::GetBkColor  
 此成员函数实现的 Win32 消息行为[TVM_GETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773570)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
##  <a name="getinsertmarkcolor"></a>CTreeCtrl::GetInsertMarkColor  
 此成员函数实现的 Win32 消息行为[TVM_GETINSERTMARKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773590)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
### <a name="parameters"></a>参数  
 `pItem`  
 指向的指针[TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456)结构中所述[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
##  <a name="getitemheight"></a>CTreeCtrl::GetItemHeight  
 此成员函数实现的 Win32 消息行为[TVM_GETITEMHEIGHT](http://msdn.microsoft.com/library/windows/desktop/bb773599)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
### <a name="parameters"></a>参数  
 ...
 `nStateMask`  
 掩码，指示要检索的一个或多个状态。 有关详细信息的可能值`nStateMask`，请参阅的讨论**状态**和**stateMask**的成员[TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456)结构[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
### <a name="remarks"></a>备注  
 此方法可发送[TVM_GETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773596)消息中所述[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。 消息返回[TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459)描述的树视图控件项目，因此该方法的结构检索`uStateEx`从该结构的成员。  
...
##  <a name="getlinecolor"></a>CTreeCtrl::GetLineColor  
 此成员函数实现的 win32 消息行为[TVM_GETLINECOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773619)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
### <a name="remarks"></a>备注  
 此成员函数实现的 win32 消息行为[TVM_GETSCROLLTIME](http://msdn.microsoft.com/library/windows/desktop/bb773625)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
##  <a name="gettextcolor"></a>CTreeCtrl::GetTextColor  
 此成员函数实现的 Win32 消息行为[TVM_GETTEXTCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773633)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
##  <a name="gettooltips"></a>CTreeCtrl::GetToolTips  
 此成员函数实现的 Win32 消息行为[TVM_GETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb773729)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
 ...
 *lpInsertStruct*  
 ...
 `nMask`  
 指定要设置的属性的整数。 请参阅`TVITEM`结构[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
 ...
 `nState`  
 指定项的状态的值。 请参阅中的树视图控件项状态[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]有关适当的状态的列表。  
  
 `nStateMask`  
 指定要设置的状态。 请参阅`TVITEM`结构[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
### <a name="remarks"></a>备注  
 辅助功能是，用于帮助残障人士使用的应用程序使用的计算机。 可访问性标识符由`IAccessible`接口才能唯一指定在窗口中的元素。 有关辅助功能标识符的详细信息，搜索在"有关活动可访问性支持"主题[Microsoft Developer Network](http://go.microsoft.com/fwlink/linkid=56322)。  
...
##  <a name="setbkcolor"></a>CTreeCtrl::SetBkColor  
 此成员函数实现的 Win32 消息行为[TVM_SETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773741)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
##  <a name="setinsertmark"></a>CTreeCtrl::SetInsertMark  
 此成员函数实现的 Win32 消息行为[TVM_SETINSERTMARK](http://msdn.microsoft.com/library/windows/desktop/bb773753)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
##  <a name="setinsertmarkcolor"></a>CTreeCtrl::SetInsertMarkColor  
 此成员函数实现的 Win32 消息行为[TVM_SETINSERTMARKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773755)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
### <a name="parameters"></a>参数  
 `pItem`  
 指向的指针[TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456)结构，其中包含新的项属性，如中所述[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
  
 `hItem`  
 要设置其属性的项的句柄。 请参阅**hItem**的成员`TVITEM`结构[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
### <a name="remarks"></a>备注  
 ...
 如果**掩码**成员或`nMask`参数指定`TVIF_TEXT`值， **pszText**成员或`lpszItem`是以 null 结尾的字符串的地址和**cchTextMax**成员将被忽略。 如果**掩码**(或`nMask`) 指定`TVIF_STATE`值， **stateMask**成员或`nStateMask`参数指定的项状态更改和**状态**成员或`nState`参数包含这些状态的值。  
...
### <a name="remarks"></a>备注  
 此方法可发送[TVM_SETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773758)消息中所述[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。 此方法将分配`iExpandedImage`参数`iExpandedImage`的成员[TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459)结构，然后在消息结构的使用。  
...
##  <a name="setitemheight"></a>CTreeCtrl::SetItemHeight  
 此成员函数实现的 Win32 消息行为[TVM_SETITEMHEIGHT](http://msdn.microsoft.com/library/windows/desktop/bb773761)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
### <a name="remarks"></a>备注  
 此方法可发送[TVM_SETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773758)消息中所述[!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。 此方法将分配`uStateEx`参数`uStateEx`的成员[TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459)结构，然后在消息结构的使用。  
...
### <a name="remarks"></a>备注  
 此成员函数实现的 win32 消息行为[TVM_SETLINECOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773764)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
### <a name="remarks"></a>备注  
 此成员函数实现的 win32 消息行为[TVM_SETSCROLLTIME](http://msdn.microsoft.com/library/windows/desktop/bb773767)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
  
##  <a name="settextcolor"></a>CTreeCtrl::SetTextColor  
 此成员函数实现的 Win32 消息行为[TVM_SETTEXTCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773769)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
##  <a name="settooltips"></a>CTreeCtrl::SetToolTips  
 此成员函数实现的 Win32 消息行为[TVM_SETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb773772)中所述， [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]。  
...
### <a name="remarks"></a>备注  
 有关工具提示和 infotips 之间的差异的详细信息，搜索在"工具提示和 Infotips"主题[Microsoft Developer Network](http://go.microsoft.com/fwlink/linkid=56322)。  
