---
title: CLongBinary 类 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="remarks"></a>备注  
 此大小可能小于分配的数据的内存块的大小。 调用 Win32 [GLobalSize](http://msdn.microsoft.com/library/windows/desktop/aa366593)函数以获取已分配的大小。  
