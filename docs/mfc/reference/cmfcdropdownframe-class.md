---
title: CMFCDropDownFrame 类 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|-|-|  
|参数|描述|  
|[in]*pWndParent*|父窗口的下拉列表框。|  
|[in]*x*|向下取帧的位置的水平屏幕坐标。|  
|[in]*y*|向下取帧的位置垂直屏幕坐标。|  
|[in]*pWndOriginToolbar*|具有此方法用于填充新的下拉列表帧对象下拉列表按钮工具栏。|  
...
### <a name="parameters"></a>参数  
 [in]*bAutoDestroy*  
 为 TRUE，则自动销毁关联的下拉列表工具栏窗口中;否则为 FALSE。  
