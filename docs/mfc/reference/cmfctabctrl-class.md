...
### <a name="remarks"></a>备注  
 此方法返回`TRUE`如果*样式*参数[CMFCTabCtrl::Create](#create)方法是 STYLE_FLAT_SHARED_HORZ_SCROLL。  
...
### <a name="remarks"></a>备注  
 使用*样式*参数[CMFCTabCtrl::Create](#create)方法，以指定如何绘制选项卡。  
...
### <a name="remarks"></a>备注  
 值*样式*参数可以是以下之一`CMFCTabCtrl::Style`枚举。  
