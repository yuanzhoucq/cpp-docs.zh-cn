---
title: CStatusBar 类 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
2.  调用[创建](#create)(或[CreateEx](#createex)) 函数来创建状态栏窗口，并将其附加到`CStatusBar`对象。  
  
3.  调用[SetIndicators](#setindicators)若要将字符串 ID 与每个指标相关联。  
