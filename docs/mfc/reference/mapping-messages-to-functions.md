...
ms.openlocfilehash: b7082e3bdd64336b87b3e4bfb30f7df9046449e8
ms.contentlocale: zh-cn
ms.lasthandoff: 09/12/2017

---
# <a name="mapping-messages-to-functions"></a>Mapping Messages to Functions
...
### <a name="to-define-or-remove-a-message-handler-using-the-properties-window"></a>To define or remove a message handler using the Properties window  
