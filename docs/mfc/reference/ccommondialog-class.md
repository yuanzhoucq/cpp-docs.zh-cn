...
helpviewer_keywords: 
  ...
  - "对话框 [C++], Windows common dialogs"
  - "dialog classes [C++], common"
  - "MFC 对话框, Windows common dialogs"
...
|名称|说明|  
|--------|--------|  
|[CCommonDialog::CCommonDialog](../Topic/CCommonDialog::CCommonDialog.md)|构造 `CCommonDialog` 对象。|  
  
## 备注  
 下面选件类封装Windows用于通用对话框的功能:  
