...
- **从添加类**
   ...
   |**File**|类型库不必在系统中进行注册，但必须包含在文件中。 必须在“位置”中提供文件位置****。|
...
- **生成的类**
   ...
   指定要使用或按钮添加的接口生成的类名 **>** **>>** 。 您可以单击此框以选择一个类，然后使用向上或向下键在列表中滚动，查看在单击 "**完成**" 时向导生成**的 "** **类**" 框中的每个类名和文件名。 在此框中仅能选择一个类。
