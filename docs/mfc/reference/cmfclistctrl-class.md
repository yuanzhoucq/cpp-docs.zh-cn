---
title: CMFCListCtrl 类 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
下面的示例演示如何使用中的各种方法`CMFCListCtrl`类。 该示例演示如何创建列表控件、 插入列、 插入项、 设置项的文本和设置列表控件的字体。 此代码片段属于[Visual Studio 演示示例](../../visual-cpp-samples.md)。
