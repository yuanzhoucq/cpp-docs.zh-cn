---
title: CTooltipManager 类 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="parameters"></a>参数  
 [out]*pToolTip*  
 工具提示指针的引用。 它是设置为时该函数将返回指向新创建的工具提示。  
...
### <a name="example"></a>示例  
 下面的示例演示如何使用`SetTooltipParams`方法的`CTooltipManager`类。 此代码片段属于 [Draw Client 示例](../../visual-cpp-samples.md)。  
