---
title: CMFCVisualManager 类 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
下面的示例演示如何使用`OnFillBarBackground`在`CMFCVisualManager`类。 此代码片段属于[Outlook 演示示例](../../visual-cpp-samples.md)。
