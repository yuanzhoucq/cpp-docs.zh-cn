...
|名称|描述|
|----------|-----------------|
|[CCustomInterpolator::GetDependencies](#getdependencies)|获取该内插器的依赖项。|
|[CCustomInterpolator::GetDuration](#getduration)|获取该内插器的持续时间。|
...
|[CCustomInterpolator::SetDuration](#setduration)|内插器的持续时间设置。|
...
|[CCustomInterpolator::m_initialValue](#m_initialvalue)|在过渡的开头的变量的值。|
|[CCustomInterpolator::m_initialVelocity](#m_initialvelocity)|在过渡的开头的变量的方向的速度。|

## <a name="remarks"></a>备注

从 CCustomInterpolator 派生一个类和重写所有必需的方法，以实现自定义内插算法。 指向此类应作为参数传递给 CCustomTransition。
