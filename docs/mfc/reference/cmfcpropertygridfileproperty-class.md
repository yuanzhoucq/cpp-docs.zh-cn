...
|名称|说明|  
|----------|-----------------|  
|`CMFCPropertyGridFileProperty::GetThisClass`|由框架用于获取一个指向[CRuntimeClass](../../mfc/reference/cruntimeclass-structure.md)程序与此类类型的对象。|  
...
### <a name="parameters"></a>参数  
 ...
 [in] `bOpenFileDialog`  
 `TRUE`若要打开**打开文件**对话框;`FALSE`若要打开**保存文件**对话框。  
