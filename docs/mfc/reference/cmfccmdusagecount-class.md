---
title: CMFCCmdUsageCount 类 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|-|-|  
|参数|描述|  
|[in]*nStartCount*|新初始计数为所有已跟踪的命令。|  
|[in]*nMinUsagePercentage*|新的最小使用率百分比。|  
