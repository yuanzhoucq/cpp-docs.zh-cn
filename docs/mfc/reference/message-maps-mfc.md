...
ms.openlocfilehash: 7a36a1ee64eef97f461d4b6e894788e71d2a40db
ms.contentlocale: zh-cn
ms.lasthandoff: 09/12/2017

---
# <a name="message-maps-mfc"></a>Message Maps (MFC)
...
## <a name="command-messages"></a>Command Messages  
  
-   Registered user-defined messages  
  
-   User-interface update messages  
  
## <a name="ranges-of-messages"></a>Ranges of Messages  
