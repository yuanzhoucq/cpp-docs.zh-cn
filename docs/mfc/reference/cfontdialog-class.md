...
*charFormat*<br/>
指向[CHARFORMAT](/windows/win32/api/richedit/ns-richedit-_charformat)数据结构的指针, 该结构允许您在 rich edit 控件中设置字体的某些特征。
...
*cf*<br/>
一个[CHARFORMAT](/windows/win32/api/richedit/ns-richedit-_charformat)结构, 其中包含有关所选字体的字符格式的信息。
