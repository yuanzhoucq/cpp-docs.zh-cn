...
若要将现有视觉对象C++中的 rich edit 控件更新到版本2.0，请打开。RC 文件作为文本，将每个 rich edit 控件的类名从 "RICHEDIT" 更改为 "RichEdit20a"。 然后，将对的`AfxInitRichEdit`调用`AfxInitRichEdit2`替换为。
