...
> [!NOTE]
>  在 MFC 4.2 之前的 MFC 版本中, **int** *nRegFlags*参数不可用。 另请注意, `afxRegInsertable`该标志不是属性页的有效选项, 如果已设置, 则将在 MFC 中引发断言
...
*pszHelpDir*<br/>
可从中找到类型库的帮助文件的名称的目录。 如果为 NULL, 则假定帮助文件与类型库本身位于同一个目录中。
