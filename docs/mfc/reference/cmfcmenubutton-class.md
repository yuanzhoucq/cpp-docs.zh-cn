...
|[CMFCMenuButton::m_bDefaultClick](#m_bdefaultclick)| 允许 （上按钮文本/图像） 的默认处理。|
...
设置为 false 的 m_bDefaultClick 会导致该按钮以显示菜单时单击该按钮上的任意位置。
...
*pMsg*<br/>
[in]指向[MSG](/windows/desktop/api/winuser/ns-winuser-tagmsg)结构，其中包含要处理的消息。
