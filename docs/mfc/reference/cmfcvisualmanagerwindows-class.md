...
|[CMFCVisualManagerWindows::IsWinXPThemeAvailable](#iswinxpthemeavailable)|指示 Windows 主题是否可用。|  
...
## <a name="remarks"></a>备注  
 使用`CMFCVisualManagerWindows`类，以更改你的应用程序模拟应用程序在其中运行的计算机上的当前主题的外观。  
