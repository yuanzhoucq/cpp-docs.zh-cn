...
有关创建映射的位图的信息，请参阅 Windows 函数[CreateMappedBitmap](https://go.microsoft.com/fwlink/p/?linkid=230562)并[颜色映射](/windows/desktop/api/commctrl/ns-commctrl-_colormap)Windows SDK 中的结构。
