...
ms.locfileid: "69508093"
---
# <a name="mfc-com"></a>MFC COM

MFC 子集旨在支持 COM, 而大多数活动模板库 (ATL) 是针对 COM 编程设计的。 本节中的主题介绍 MFC 对 COM 的支持。

活动技术 (如 ActiveX 控件、活动文档包含项、OLE 等) 使用组件对象模型 (COM) 使软件组件能够在网络环境中互相交互, 而不管它们使用何种语言建立. 活动技术可用于创建在桌面或 Internet 上运行的应用程序。 有关详细信息, 请参阅 COM 或[组件对象模型](/windows/win32/com/the-component-object-model)[简介](../atl/introduction-to-com.md)。
...
- ActiveX 控件是可以在网站等容器中使用的交互式对象。 有关 ActiveX 控件的详细信息, 请参阅:
   ...
   - [叙述Internet](../mfc/mfc-internet-programming-basics.md)
...
- 本部分还提供了有关如何使用 MFC (例如[连接点](../mfc/connection-points.md)) 编写 COM 组件的信息。

有关仍称为 OLE 的内容与目前称为活动技术的内容的讨论, 请参阅有关[ole](../mfc/ole-in-mfc.md)的主题。
