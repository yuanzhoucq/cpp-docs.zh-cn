...
在对话框编辑器中工作时应注意以下几个问题。  
  
-   [向对话框添加控件导致对话框不再工作](../mfc/adding-controls-to-a-dialog-causes-the-dialog-to-no-longer-function.md)  
  
-   [对 RichEdit 1.0 控件使用 MFC](../mfc/using-the-richedit-1-0-control-with-mfc.md)  
