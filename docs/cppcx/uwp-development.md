...
---
# <a name="uwp-development-with-c"></a>使用 UWP 开发C++
...
此位置中的内容介绍了两个较旧的 UWP 技术的C++:

- [ C++/CX 语言扩展。](visual-c-language-reference-c-cx.md)
- [Windows 运行时C++模板库 (WRL)](../windows/windows-runtime-cpp-template-library-wrl.md)。

这两种技术继续受到支持，但通常不建议用于新的开发。

## <a name="related-articles"></a>相关文章
[开始使用 Windows 10 应用](/windows/uwp/get-started/)
[开始使用C++/WinRT](/windows/uwp/cpp-and-winrt-apis/get-started)
