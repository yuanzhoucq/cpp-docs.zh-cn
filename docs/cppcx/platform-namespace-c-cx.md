---
title: "Platform 命名空间 (C++/CX) | Microsoft Docs"
ms.custom: ""
ms.date: "12/30/2016"
...
## 成员  
 该平台命名空间从 IUnknown 接口继承，但不包含其他成员。  
...
|[Platform::FailureException 类](../cppcx/platform-failureexception-class.md)|操作失败时引发。 它是 E\_FAIL HRESULT 的等效项。|  
...
## 请参阅  
 ...
 [Platform::Runtime::CompilerServices 命名空间](../cppcx/platform-runtime-compilerservices-namespace.md)   
 [Platform::Runtime::InteropServices 命名空间](../cppcx/platform-runtime-interopservices-namespace.md)   
