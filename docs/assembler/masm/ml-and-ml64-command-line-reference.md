...
|**/ERRORREPORT** [ **NONE** &#124;**提示**&#124;**队列**&#124;**发送**]|如果 ml.exe 或 ml64.exe 运行时失败，则可以使用**/ERRORREPORT**信息向 Microsoft 发送有关这些内部错误。<br /><br /> 有关详细信息**/ERRORREPORT**，请参阅[/errorReport （报告内部编译器错误）](../../build/reference/errorreport-report-internal-compiler-errors.md)。|  
