...
- [在内联程序集中调用C++函数](../../assembler/inline/calling-cpp-functions-in-inline-assembly.md)
...
[编译器内部函数和汇编语言](../../intrinsics/compiler-intrinsics-and-assembly-language.md)<br/>
