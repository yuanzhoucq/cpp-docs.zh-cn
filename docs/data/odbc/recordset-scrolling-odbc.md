...
3.  到记录集中的第一个记录： 调用[MoveFirst](../../mfc/reference/crecordset-class.md#movefirst)成员函数。  
  
4.  到记录集中的最后一个记录或最后一个行集： 调用[MoveLast](../../mfc/reference/crecordset-class.md#movelast)成员函数。  
