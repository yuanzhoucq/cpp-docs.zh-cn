...
3.  在中**创建新的数据源**对话框中，选择一个 Excel 驱动程序，并单击**下一步**。  
...
2.  在中**ODBC Microsoft Excel 安装程序**对话框框中，选择数据库版本和工作簿。  
...
2.  而不是销毁的对象，调用其`OpenEx`或`Open`再次成员函数。  
