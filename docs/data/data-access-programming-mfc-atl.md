...
## <a name="see-also"></a>请参阅  
 [数据访问](data-access-in-cpp.md) [Microsoft 开放式数据库连接 (ODBC)](https://docs.microsoft.com/sql/odbc/microsoft-open-database-connectivity-odbc) [数据访问技术路线图](https://msdn.microsoft.com/library/ms810810.aspx)