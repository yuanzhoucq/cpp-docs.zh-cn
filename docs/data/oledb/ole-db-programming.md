...
|OLE DB 模板类和宏|[OLE DB 模板参考](../../data/oledb/ole-db-templates.md)（视觉C++对象）|
...
|OLE DB 模板示例|[OLE DB 模板示例](https://github.com/Microsoft/VCSamples/tree/master/VC2010Samples/ATL/OLEDB)|
