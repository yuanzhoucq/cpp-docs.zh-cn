...
typedef 类调用 **CSchemata** 实现其参数类的 **CSchemataInfo**。  
...
## 备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 行。  有关架构和列的详细信息，请参阅 *OLE DB Programmer's Reference* 中的 [SCHEMATA Rowset](https://msdn.microsoft.com/en-us/library/ms716887.aspx)。  
