...
架构是所拥有或由特定用户创建的数据库对象的集合。 目录可以包含一个或多个架构，但必须始终包含名为 INFORMATION_SCHEMA，其中包含的视图和域信息架构的架构。 OLE DB 中的架构信息使用预定义的架构行集检索，并且包括类型、 表、 列、 索引、 视图、 断言和约束、 统计信息、 字符集、 排序规则和域。  
 ...
 使用 typedef 类实例化的架构行集。 下面列出了相应的 typedef 和架构行集类。 必须调用[crestrictions:: Open](../../data/oledb/crestrictions-open.md)创建架构行集的实例之后。 此方法返回基于所指定的限制的结果集。 请参阅[IDBSchemaRowset](https://msdn.microsoft.com/library/ms713686.aspx)有关与每个架构行集相关联的限制列的信息。  
  
 下表显示了每个 OLE DB 架构行集和其对应 OLE DB 模板 typedef 类和类信息。  
  
|OLE DB 架构行集|Typedef 类|信息类|  
|--------------------------|-------------------|----------------|  
|[断言](https://msdn.microsoft.com/library/ms719776.aspx)|[CAssertions](#assertion)|[CAssertionInfo](#assertion)|  
|[目录](https://msdn.microsoft.com/library/ms721241.aspx)|[CCatalogs](#catalog)|[CCatalogInfo](#catalog)|  
|[CHARACTER_SETS](https://msdn.microsoft.com/library/ms722638.aspx)|[CCharacterSets](#characterset)|[CCharacterSetInfo](#characterset)|  
|[排序规则](https://msdn.microsoft.com/library/ms715783.aspx)|[CCollations](#collation)|[CCollationInfo](#collation)|  
...
|[列](https://msdn.microsoft.com/library/ms723052.aspx)|[CColumns](#columns)|[CColumnsInfo](#columns)|  
...
|[过程](https://msdn.microsoft.com/library/ms724021.aspx)|[CProcedures](#procedure)|[CProcedureInfo](#procedure)|  
...
|[架构](https://msdn.microsoft.com/library/ms716887.aspx)|[CSchemata](#schemata)|[CSchemataInfo](#schemata)|  
...
|[表](https://msdn.microsoft.com/library/ms716980.aspx)|[CTables](#table)|[CTableInfo](#table)|  
...
|[翻译](https://msdn.microsoft.com/library/ms725365.aspx)|[CTranslations](#translation)|[CTranslationInfo](#translation)|  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员的`CAssertionInfo`和其对应的 OLE DB 列。 请参阅[断言行集](https://msdn.microsoft.com/library/ms719776.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[目录行集](https://msdn.microsoft.com/library/ms721241.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[CHARACTER_SETS 行集](https://msdn.microsoft.com/library/ms722638.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[CHECK_CONSTRAINTS 行集](https://msdn.microsoft.com/library/ms712845.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[排序规则行集](https://msdn.microsoft.com/library/ms715783.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[COLUMN_DOMAIN_USAGE 行集](https://msdn.microsoft.com/library/ms711240.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[COLUMN_PRIVILEGES 行集](https://msdn.microsoft.com/library/ms715800.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[COLUMNS 行集](https://msdn.microsoft.com/library/ms723052.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[CONSTRAINT_COLUMN_USAGE 行集](https://msdn.microsoft.com/library/ms724522.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[CONSTRAINT_TABLE_USAGE 行集](https://msdn.microsoft.com/library/ms724522.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[FOREIGN_KEYS 行集](https://msdn.microsoft.com/library/ms711276.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[索引行集](https://msdn.microsoft.com/library/ms709712.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[KEY_COLUMN_USAGE 行集](https://msdn.microsoft.com/library/ms712990.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[PRIMARY_KEYS 行集](https://msdn.microsoft.com/library/ms714362.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[PROCEDURE_COLUMNS 行集](https://msdn.microsoft.com/library/ms723092.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[PROCEDURE_PARAMETERS 行集](https://msdn.microsoft.com/library/ms713623.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[过程行集](https://msdn.microsoft.com/library/ms724021.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[PROVIDER_TYPES 行集](https://msdn.microsoft.com/library/ms709785.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[REFERENTIAL_CONSTRAINTS 行集](https://msdn.microsoft.com/library/ms719737.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[架构行集](https://msdn.microsoft.com/library/ms716887.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[SQL_LANGUAGES 行集](https://msdn.microsoft.com/library/ms714374.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[统计信息行集](https://msdn.microsoft.com/library/ms715957.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[TABLE_CONSTRAINTS 行集](https://msdn.microsoft.com/library/ms715921.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[TABLE_PRIVILEGES 行集](https://msdn.microsoft.com/library/ms725428.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[TABLES 行集](https://msdn.microsoft.com/library/ms716980.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[翻译行集](https://msdn.microsoft.com/library/ms725365.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[USAGE_PRIVILEGES 行集](https://msdn.microsoft.com/library/ms722743.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[VIEW_COLUMN_USAGE 行集](https://msdn.microsoft.com/library/ms714896.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[视图行集](https://msdn.microsoft.com/library/ms723122.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
...
### <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[VIEW_TABLE_USAGE 行集](https://msdn.microsoft.com/library/ms719727.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
