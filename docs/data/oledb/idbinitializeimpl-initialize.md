---
title: 'Idbinitializeimpl:: Initialize |Microsoft 文档'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
## <a name="remarks"></a>备注  
 请参阅[idbinitialize:: Initialize](https://msdn.microsoft.com/en-us/library/ms718026.aspx)中*OLE DB 程序员参考*。  
