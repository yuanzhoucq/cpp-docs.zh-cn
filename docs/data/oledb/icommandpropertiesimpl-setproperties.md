---
title: 'Icommandpropertiesimpl:: Setproperties |Microsoft 文档'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
#### <a name="parameters"></a>参数  
 请参阅[ICommandProperties::SetProperties](https://msdn.microsoft.com/en-us/library/ms711497.aspx)中*OLE DB 程序员参考*。  
