---
title: CTables，CTableInfo |Microsoft 文档
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
## <a name="remarks"></a>备注  
 ...
 此类标识基于的表时，在目录中，定义适用于或给定用户授予的特权。  
  
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[表行集](https://msdn.microsoft.com/en-us/library/ms716980.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
