---
title: CPrimaryKeys，CPrimaryKeyInfo |Microsoft 文档
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
## <a name="remarks"></a>备注  
 ...
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[PRIMARY_KEYS 行集](https://msdn.microsoft.com/en-us/library/ms714362.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
