...
## <a name="remarks"></a>备注  
 ...
 此类标识表定义的约束，在目录中，属于给定用户。  
  
 下表列出了类数据成员及其对应的 OLE DB 列。 请参阅[TABLE_CONSTRAINTS 行集](https://msdn.microsoft.com/en-us/library/ms715921.aspx)中*OLE DB 程序员参考*有关的架构和列的详细信息。  
