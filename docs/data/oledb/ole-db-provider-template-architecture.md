...
|组件|接口|注释|  
|---------------|---------------|-------------|  
|[数据源](../../data/oledb/data-source-object-interfaces.md)([CDataSource](../../data/oledb/cdatasource-class.md))|[mandatory] **IDBCreateSession**<br /><br /> [必需]**IDBInitialize**<br /><br /> [必需] `IDBProperties`<br /><br /> [必需] `IPersist`<br /><br /> [可选]**IConnectionPointContainer**<br /><br /> [可选]**IDBAsynchStatus**<br /><br /> [可选]**IDBDataSourceAdmin**<br /><br /> [可选]**IDBInfo**<br /><br /> [可选] `IPersistFile`<br /><br /> [可选]**ISupportErrorInfo**|从使用者到提供程序的连接。 对象用于指定用户 ID、 密码和数据源名称等连接上的属性。 对象还可以用于管理数据源 （创建、 更新、 删除、 表和等）。|  
