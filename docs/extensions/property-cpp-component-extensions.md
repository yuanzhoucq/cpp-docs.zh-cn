...
**`property`** 是上下文相关的关键字。  有关详细信息，请参阅[上下文相关关键字](context-sensitive-keywords-cpp-component-extensions.md)。
