---
title: 如何：使用 const 关键字声明内部指针 (C++/CLI)
ms.date: 10/12/2018
ms.topic: reference
helpviewer_keywords:
- pointers, interior
...
ms.locfileid: "65515772"
---
# <a name="how-to-declare-interior-pointers-with-the-const-keyword-ccli"></a>如何：使用 const 关键字声明内部指针 (C++/CLI)
