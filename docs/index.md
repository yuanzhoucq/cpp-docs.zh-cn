...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>安装 Visual Studio 并选择你的 C++ 工作负载</h3>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <ul class="pivots">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>使用 C++ 开发通用 Windows 平台 (UWP) 的应用。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>使用 Win32、MFC、ATL、COM 和/或 C++/CLI 创建经典 Windows 桌面应用程序、静态库和 DLL。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 C++ 的移动开发</h3>
                                                    <p>针对 iOS、Android 和 UWP 创建移动应用程序。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 C++ 的游戏开发</h3>
                                                    <p>使用 DirectX、Unreal 和 Cocos2D 等创建游戏和图形应用程序。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Python</h3>
                                                    <p>使用针对 Visual Studio 的 Python 工具创建与 C++ 程序交互的 Python 应用程序。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>调试</h3>
                                                    <p>使用 Visual Studio 调试器调试 C++ 代码。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>移植和升级</h3>
                                                    <p>升级到最新版本的 Visual Studio，并将旧版应用迁移到新式平台。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#langlib">语言和库</a>
                <ul id="langlib">
                    <li>
                        <a href="#langlib1">语言和库</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>组件扩展</h3>
                                                    <p>C++ 的组件扩展：适用于 .NET 编程的 C++/CLI 和适用于 UWP 编程的 C++/CX。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 桌面库</h3>
                                                    <p>Microsoft 基础类 (MFC) 和活动模板库 (ATL)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>并行编程库</h3>
                                                    <p>用于并行编程的 Concrt、AMP 和 OpenMP 库。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>通用 Windows 平台库</h3>
                                                    <p>Windows 运行时 C++ 模板库 (WRL) 是一个提供低级别方式来创作和使用 Windows 运行时组件的模板库。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
