...
ms.locfileid: "45714592"
---
# <a name="fs-force-synchronous-pdb-writes"></a>/FS（强制同步 PDB 写入）

强制写入到程序数据库 (PDB) 文件，创建[/Zi](../../build/reference/z7-zi-zi-debug-information-format.md)或[/ZI](../../build/reference/z7-zi-zi-debug-information-format.md)— 通过 MSPDBSRV 要序列化。EXE。
