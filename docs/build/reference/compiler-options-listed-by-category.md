...
本文包含编译器选项的分类列表。 有关按字母顺序排序的列表，请参见 [Compiler Options Listed Alphabetically](../../build/reference/compiler-options-listed-alphabetically.md)。  
...
|[/Yc](../../build/reference/yc-create-precompiled-header-file.md)|创建。PCH 文件。|  
...
### <a name="deprecated-and-removed-compiler-options"></a>已弃用并删除的编译器选项  
  
|选项|目标|  
|------------|-------------|  
|[/clr:noAssembly](../../build/reference/clr-common-language-runtime-compilation.md)|已否决。 请改用 [/LN (Create MSIL Module)](../../build/reference/ln-create-msil-module.md) 。|  
