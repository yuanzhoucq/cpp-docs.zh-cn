...
|[\/Qpar（自动并行化程序）](../../build/reference/qpar-auto-parallelizer.md)|对标记有 [\#pragma loop\(\)](../../preprocessor/loop.md) 指令的循环启用自动并行化。|  
...
|[\/Tc](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)<br /><br /> [\/TC](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)|指定 C 源文件。|  
|[\/Tp](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)<br /><br /> [\/TP](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)|指定 C\+\+ 源文件。|  
...
|[\/Zc](../../build/reference/zc-conformance.md)|在 [\/Ze](../../build/reference/za-ze-disable-language-extensions.md) 之下指定标准行为。[\/Za、\/Ze（禁用语言扩展）](../../build/reference/za-ze-disable-language-extensions.md)|  
