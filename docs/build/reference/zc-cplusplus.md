...
ms.locfileid: "57810089"
---
# <a name="zccplusplus-enable-updated-cplusplus-macro"></a>/Zc: __cplusplus （启用更新的 __cplusplus 宏）

**/Zc: __cplusplus**编译器选项启用 **\_ \_cplusplus**预处理器宏来报告最新 c + + 语言标准支持的更新的值。 默认情况下，Visual Studio 始终为返回的值"199711 L"  **\_ \_cplusplus**预处理器宏。
