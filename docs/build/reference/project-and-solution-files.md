...
|Projname.vcxproj|Projname|在解决方案资源管理器中不显示|项目文件。 它存储特定于每个项目的信息。 （在早期版本中，此文件命名为 Projname.vcproj 或 Projname.dsp。）有关 C++ 项目文件 (.vcxproj) 的示例，请参阅[项目文件](project-files.md)。|
