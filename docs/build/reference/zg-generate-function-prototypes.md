 ...
 **/Zg**选项在 Visual Studio 2005 中已弃用，并且已在 Visual Studio 2015 中删除。 Visual c + + 编译器已删除对较旧的 C 样式代码的支持。 不推荐使用的编译器选项的列表，请参阅**已弃用并删除的编译器选项**中[按类别列出的编译器选项](../../build/reference/compiler-options-listed-by-category.md)。  
