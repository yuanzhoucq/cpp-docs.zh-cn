...
如果通常通过使用生成 64 位 x64 编译器编译你的应用程序代码中，您只需禁用 **/wp64**在 32 位编译中因为 64 位编译器会检测所有问题。 有关如何面向 Windows 64 位操作系统的详细信息，请参阅[配置C++项目的 64 位 x64 目标](../configuring-programs-for-64-bit-visual-cpp.md)。
...
[配置C++适用于 64 位 x64 目标项目](../configuring-programs-for-64-bit-visual-cpp.md)
