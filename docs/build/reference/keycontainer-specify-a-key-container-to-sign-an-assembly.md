...
此外可以将加密信息传递给编译器[/KEYFILE](keyfile-specify-key-or-key-pair-to-sign-an-assembly.md)。 使用[/DELAYSIGN](delaysign-partially-sign-an-assembly.md)如果需要部分签名的程序集。 请参阅[强名称程序集 （程序集签名） (C++/CLI)](../../dotnet/strong-name-assemblies-assembly-signing-cpp-cli.md)有关签名程序集的详细信息。
