...
## <a name="remarks"></a>备注  
 ...
 默认情况下，/TSAWARE 选项启用 Windows 和控制台应用程序。 请参阅[/SUBSYSTEM](../../build/reference/subsystem-specify-subsystem.md)和[/VERSION](../../build/reference/version-version-information.md)有关信息。  
