...
## <a name="remarks"></a>备注  
 ...
 如果你使用 __/Yc__*filename*，编译器将编译所有代码，随后用于为指定的文件包括[/Yu （使用预编译标头文件）](../../build/reference/yu-use-precompiled-header-file.md)选项。  
  
 如果选项 __/Yc__*filename*和 __/Yu__*filename*出现在相同的命令行和两个引用，或暗示的相同的文件名称，__/Yc__*filename*优先。 此功能简化了生成文件的写入。  
