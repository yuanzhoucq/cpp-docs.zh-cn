...
|[\/MANIFESTDEPENDENCY](../../build/reference/manifestdependency-specify-manifest-dependencies.md)|在清单文件中指定 \<dependentAssembly\> 节。|  
...
|[\/WX](../../build/reference/wx-treat-linker-warnings-as-errors.md)|将链接器警告视为错误。|  
 ...
 有关详细信息，请参阅 [编译器控制的 LINK 选项](../../build/reference/compiler-controlled-link-options.md)。  
  
## 请参阅  
 [C\/C\+\+ 生成参考](../../build/reference/c-cpp-building-reference.md)   
 [设置链接器选项](../../build/reference/setting-linker-options.md)   
 [有关生成的常见问题](http://msdn.microsoft.com/zh-cn/56a3bb8f-0181-4989-bab4-a07ba950ab08)