...
可以使用 CMake 生成 Qt 项目，也可以使用[Qt Visual Studio 扩展](https://download.qt.io/development_releases/vsaddin/)Visual Studio 2015 或 Visual Studio 2017。
