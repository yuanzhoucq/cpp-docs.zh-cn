...
ms.locfileid: "81319130"
---
# <a name="ca2wex-class"></a>CA2WEX 类

此类由字符串转换宏 CA2TEX、CA2CTEX、CT2WEX 和 CT2CWEX 以及类型def CA2W 使用。
...
|名称|说明|
|----------|-----------------|
|[CA2WEX：：操作员LPWSTR](#operator_lpwstr)|转换运算符。|
...
除非需要额外的功能，否则请使用 CA2TEX、CA2CTEX、CT2WEX、CT2CWEX 或 CA2W 代码。
...
## <a name="ca2wexoperator-lpwstr"></a><a name="operator_lpwstr"></a>CA2WEX：：操作员LPWSTR
