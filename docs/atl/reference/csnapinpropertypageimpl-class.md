---
title: CSnapInPropertyPageImpl 类 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
### <a name="remarks"></a>备注  
 ...
 此结构，包括其成员的列表的详细信息请参阅[PROPSHEETPAGE](https://msdn.microsoft.com/library/aa815151) Windows SDK 中。  
