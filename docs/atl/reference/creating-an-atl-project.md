...
2.  选择**ATL 项目**在模板窗格中，若要打开 ATL 项目向导的图标。  
  
3.  定义你使用的应用程序设置[应用程序设置](../../atl/reference/application-settings-atl-project-wizard.md)页`ATL Project Wizard`。  
