---
title: CComObject 类 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
##  <a name="createinstance"></a>  CComObject::CreateInstance  
 此静态函数，可创建一个新**CComObject <** `Base` **>** 对象，而不需要的开销[CoCreateInstance](http://msdn.microsoft.com/library/windows/desktop/ms686615)。  
