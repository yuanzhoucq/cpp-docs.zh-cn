...
### <a name="remarks"></a>备注  
 设置`pdwAttributes`到 NULL 提供一种确认是否存在`CSid`无需访问该属性。 请注意，此方法不应检查访问权限。 应用程序应改用[CAccessToken::CheckTokenMembership](../../atl/reference/caccesstoken-class.md#checktokenmembership)方法。  
