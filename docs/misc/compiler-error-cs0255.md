...
stackalloc 不能用在 catch 或 finally 块中  
 ...
 [stackalloc](../Topic/stackalloc%20\(C%23%20Reference\).md) 关键字不能用在 [catch](../Topic/try-catch%20\(C%23%20Reference\).md) 或 [finally](../Topic/try-catch-finally%20\(C%23%20Reference\).md) 块中。 有关更多信息，请参见[异常和异常处理](../Topic/Exceptions%20and%20Exception%20Handling%20\(C%23%20Programming%20Guide\).md)。  
