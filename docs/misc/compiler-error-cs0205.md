...
无法调用抽象基成员：“method”  
 ...
 无法调用 [abstract](../Topic/abstract%20\(C%23%20Reference\).md) 方法，因为没有方法正文。 有关更多信息，请参见[抽象类、密封类及类成员](../Topic/Abstract%20and%20Sealed%20Classes%20and%20Class%20Members%20\(C%23%20Programming%20Guide\).md)。  
