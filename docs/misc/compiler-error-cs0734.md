...
只有在生成 "module" 目标类型时才能指定 \/moduleassemblyname 选项  
 ...
 编译器选项 **\/moduleassemblyname** 应仅用于生成 .netmodule 时。 有关更多信息，请参见[\/moduleassemblyname \(Specify Friend Assembly for Module\)](../Topic/-moduleassemblyname%20\(C%23%20Compiler%20Option\).md)。  
