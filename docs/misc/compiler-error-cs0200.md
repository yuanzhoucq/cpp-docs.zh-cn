...
无法对属性或索引器“property”赋值 \- 它是只读的  
 ...
 尝试给 [属性](../Topic/Using%20Properties%20\(C%23%20Programming%20Guide\).md)赋值，但该属性没有 set 访问器。 通过添加 set 访问器解决该错误。 有关详细信息，请参阅[如何：声明和使用读\/写属性](../Topic/How%20to:%20Declare%20and%20Use%20Read%20Write%20Properties%20\(C%23%20Programming%20Guide\).md)。  
