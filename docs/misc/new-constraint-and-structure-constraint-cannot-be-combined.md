...
约束列表同时包含 [New 运算符](../Topic/New%20Operator%20\(Visual%20Basic\).md) 约束和 [Structure \(Visual Basic\)](http://msdn.microsoft.com/zh-cn/263ce115-ac36-4c05-8cb7-0e0eead5c6d0) 约束。  
