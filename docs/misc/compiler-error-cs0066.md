...
“event”: 事件必须是委托类型  
 ...
 事件关键字需要[委托](../Topic/delegate%20\(C%23%20Reference\).md)类型。 有关详细信息，请参阅[事件](../Topic/Events%20\(C%23%20Programming%20Guide\).md)和[委托](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md)。  
