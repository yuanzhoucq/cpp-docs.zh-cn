...
[Imports 语句（.NET 命名空间和类型）](../Topic/Imports%20Statement%20\(.NET%20Namespace%20and%20Type\).md) 指定无法导入的编程元素。  
...
## 请参阅  
 [引用和 Imports 语句](../Topic/References%20and%20the%20Imports%20Statement%20\(Visual%20Basic\).md)