...
空语句可能有错误  
 ...
 可以使用 **\/nowarn** 编译器选项或 `#pragmas warning` 禁用此警告；有关详细信息，请参阅 [\/nowarn \(Suppress Specified Warnings\)](../Topic/-nowarn%20\(C%23%20Compiler%20Options\).md)或 [\#pragma warning](../Topic/%23pragma%20warning%20\(C%23%20Reference\).md)。  
