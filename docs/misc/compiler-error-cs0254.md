---
title: "编译器错误 CS0254 | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
fixed 语句赋值的右边不能是强制转换表达式  
 ...
 不能强制转换[固定](../Topic/fixed%20Statement%20\(C%23%20Reference\).md)表达式的右侧。 有关详细信息，请参阅[不安全代码和指针](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md)。  
