...
```  
 ...
 默认情况下，此消息是一个警告。 有关如何隐藏警告或如何将警告视为错误的信息，请参见 [在 Visual Basic 中配置警告](../Topic/Configuring%20Warnings%20in%20Visual%20Basic.md)。  
...
## 请参阅  
 ...
 [局部类型推理](../Topic/Local%20Type%20Inference%20\(Visual%20Basic\).md)   
 [Option Infer 语句](../Topic/Option%20Infer%20Statement.md)   
