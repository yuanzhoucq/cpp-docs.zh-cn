...
[!INCLUDE[vbprvb](../Token/vbprvb_md.md)] 编译器不能从以下的错误中恢复：\<`error`\>。  
  
 已禁用某些 IDE 功能。  
  
 [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] 编译器中发生了内部错误。  
  
 **错误 ID：**BC31021  
  
### 更正此错误  
  
1.  保存所做的工作并重新启动 [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)]。  
  
2.  如果错误重复出现，请重新安装 [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)]。  
