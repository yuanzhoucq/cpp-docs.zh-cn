...
"is" 和 "as" 在指针类型上都无效  
 ...
 [is](../Topic/is%20\(C%23%20Reference\).md) 和 [as](../Topic/as%20\(C%23%20Reference\).md) 关键字不能有效使用于指针类型。 有关详细信息，请参阅[不安全代码和指针](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md)。  
