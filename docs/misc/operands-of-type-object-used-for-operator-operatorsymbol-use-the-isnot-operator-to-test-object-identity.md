---
title: "对运算符“&lt;operatorsymbol&gt;”使用了 Object 类型的操作数；应使用“IsNot”运算符来测试对象标识 | Microsoft Docs"
ms.custom: ""
ms.date: "11/17/2016"
...
表达式将 `<>` 运算符与 [Object 数据类型](../Topic/Object%20Data%20Type.md) 的一个或两个操作数一起使用。  
...
## 请参阅  
 ...
 [IsNot 运算符](../Topic/IsNot%20Operator%20\(Visual%20Basic\).md)   
