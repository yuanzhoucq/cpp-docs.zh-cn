...
[Get 语句](../Topic/Get%20Statement.md) 或 [Set 语句](../Topic/Set%20Statement%20\(Visual%20Basic\).md)，用于指定限制性更弱的访问级别，该访问级别的限制性比为包含属性指定的限制性更弱。  
...
-   在 [Property 语句](../Topic/Property%20Statement.md) 中声明限制性较弱的访问级别，并在属性过程之一当中声明限制性更强的访问级别。  
