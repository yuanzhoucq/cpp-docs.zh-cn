...
因为“member”不是重写，所以无法将其密封  
 ...
 对还未使用 [override](../Topic/override%20\(C%23%20Reference\).md) 进行标记的成员使用了[密封](../Topic/sealed%20\(C%23%20Reference\).md)。 有关更多信息，请参见[继承](../Topic/Inheritance%20\(C%23%20Programming%20Guide\).md)。  
