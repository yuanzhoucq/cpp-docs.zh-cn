...
已针对不属于类型 <xref:System.Xml.Linq.XElement>、<xref:System.Xml.Linq.XDocument> 或 `IEnumerable(Of XElement)` 的对象引用一个 XML 子代。 有关更多信息，请参见[XML 后代轴属性](../Topic/XML%20Descendant%20Axis%20Property%20\(Visual%20Basic\).md)。  
...
## 请参阅  
 [XML 后代轴属性](../Topic/XML%20Descendant%20Axis%20Property%20\(Visual%20Basic\).md)   
