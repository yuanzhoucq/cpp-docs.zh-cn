...
可访问性不一致：基接口“interface 1”的可访问性低于接口“interface 2”  
 ...
 [公共](../Topic/public%20\(C%23%20Reference\).md)构造必须返回可以公开访问的对象。  
  
 派生接口中不能收缩接口的可访问性。 有关详细信息，请参阅[接口](../Topic/Interfaces%20\(C%23%20Programming%20Guide\).md)和[访问修饰符](../Topic/Access%20Modifiers%20\(C%23%20Programming%20Guide\).md)。  
