...
“member1”: 无法重写，因为“member2”不是函数  
 ...
 类声明已尝试重写基类中的非方法。 重写必须与成员类型相匹配。 如果所需方法的名称要与基类中某方法的名称相同，请在基类的方法声明上使用 [new](../Topic/new%20\(C%23%20Reference\).md)（而不是 [override](../Topic/override%20\(C%23%20Reference\).md)）。  
