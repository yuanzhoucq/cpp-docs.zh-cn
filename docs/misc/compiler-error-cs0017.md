...
程序“输出文档名称”定义了多个入口点。 请使用 \/main 进行编译，以指定包含入口点的类型。  
 ...
 一个程序只能有一个 [Main](../Topic/Main\(\)%20and%20Command-Line%20Arguments%20\(C%23%20Programming%20Guide\).md) 方法。  
  
 若要解决此错误，你可以在代码中删除所有 Main 方法，仅保留一个，或者可以使用 [\/main](../Topic/-main%20\(C%23%20Compiler%20Options\).md) 编译器选项来指定想要使用的 Main 方法。  
