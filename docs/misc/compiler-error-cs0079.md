...
事件“event”只能出现在 \+\= 或 \-\= 的左边  
 ...
 未正确调用 [event](../Topic/event%20\(C%23%20Reference\).md)。 有关详细信息，请参阅 [事件](../Topic/Events%20\(C%23%20Programming%20Guide\).md) 和 [委托](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md)。  
